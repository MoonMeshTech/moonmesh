...
#define ECDH_SHARED_KEY_LENGTH   32
 ...
 * @return      false
*/
bool generate_ecdh_keys(uint8_t ecdh_public_key[EC_PUBLIC_KEY_LENGTH],
 ...
 * @return      false
*/
bool calculate_ecdh_shared_key(const uint8_t ecdh1_public_key[EC_PUBLIC_KEY_LENGTH],
 ...
 * @return      false
*/
bool ecdsa_sign(const uint8_t ec_private_key[EC_PRIVATE_KEY_LENGTH], uint8_t *hash, uint8_t hash_len, uint8_t sign[CRYPTO_ECDSA_SIG_LEN]);
 ...
 * @return      bool
*/
bool ecdsa_verify(const uint8_t ec_public_key[EC_PUBLIC_KEY_LENGTH], const uint8_t *hash, int hash_len, const uint8_t sign[CRYPTO_ECDSA_SIG_LEN]);
/**
 * @brief
 * 
 * @param       hmac:
 ...
 * @return      false
*/
bool createHkdfBytes(const uint8_t ecdh_shared_key[ECDH_SHARED_KEY_LENGTH],
