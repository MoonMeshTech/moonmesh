...
void logWriter(const std::string& content, OUTTYPE out = file, const std::string& log_name = "new_tmp.log");
...
#define infoL(msg,...) \
    std::cout << GREEN_t <<  Sutil::Format(msg, ##__VA_ARGS__)<< BASECOLOER <<std::endl;
