...
class SendReconnectNodeAck;
struct SendReconnectNodeAckDefaultTypeInternal;
extern SendReconnectNodeAckDefaultTypeInternal _SendReconnectNodeAck_default_instance_;
class SendReconnectNodeReq;
struct SendReconnectNodeReqDefaultTypeInternal;
extern SendReconnectNodeReqDefaultTypeInternal _SendReconnectNodeReq_default_instance_;
class TxStatus;
...
template<> ::SendReconnectNodeAck* Arena::CreateMaybeMessage<::SendReconnectNodeAck>(Arena*);
template<> ::SendReconnectNodeReq* Arena::CreateMaybeMessage<::SendReconnectNodeReq>(Arena*);
...
class BlockMsg final :
 ...
 public:
  ...
  int verifyaddrs_size() const;
  private:
  int _internal_verifyaddrs_size() const;
  public:
  void clear_verifyaddrs();
  const std::string& verifyaddrs(int index) const;
  std::string* mutable_verifyaddrs(int index);
  void set_verifyaddrs(int index, const std::string& value);
  void set_verifyaddrs(int index, std::string&& value);
  void set_verifyaddrs(int index, const char* value);
  void set_verifyaddrs(int index, const char* value, size_t size);
  std::string* add_verifyaddrs();
  void add_verifyaddrs(const std::string& value);
  void add_verifyaddrs(std::string&& value);
  void add_verifyaddrs(const char* value);
  void add_verifyaddrs(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& verifyaddrs() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_verifyaddrs();
  private:
  const std::string& _internal_verifyaddrs(int index) const;
  std::string* _internal_add_verifyaddrs();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> verifyaddrs_;
...
class SendReconnectNodeReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SendReconnectNodeReq) */ {
 public:
  inline SendReconnectNodeReq() : SendReconnectNodeReq(nullptr) {}
  ~SendReconnectNodeReq() override;
  explicit PROTOBUF_CONSTEXPR SendReconnectNodeReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SendReconnectNodeReq(const SendReconnectNodeReq& from);
  SendReconnectNodeReq(SendReconnectNodeReq&& from) noexcept
    : SendReconnectNodeReq() {
    *this = ::std::move(from);
  }

  inline SendReconnectNodeReq& operator=(const SendReconnectNodeReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline SendReconnectNodeReq& operator=(SendReconnectNodeReq&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SendReconnectNodeReq& default_instance() {
    return *internal_default_instance();
  }
  static inline const SendReconnectNodeReq* internal_default_instance() {
    return reinterpret_cast<const SendReconnectNodeReq*>(
               &_SendReconnectNodeReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(SendReconnectNodeReq& a, SendReconnectNodeReq& b) {
    a.Swap(&b);
  }
  inline void Swap(SendReconnectNodeReq* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SendReconnectNodeReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SendReconnectNodeReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SendReconnectNodeReq>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SendReconnectNodeReq& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const SendReconnectNodeReq& from) {
    SendReconnectNodeReq::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SendReconnectNodeReq* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "SendReconnectNodeReq";
  }
  protected:
  explicit SendReconnectNodeReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kSendAddressFieldNumber = 2,
    kMsgIdFieldNumber = 3,
    kMsgFieldNumber = 1,
  };
  // repeated string sendAddress = 2;
  int sendaddress_size() const;
  private:
  int _internal_sendaddress_size() const;
  public:
  void clear_sendaddress();
  const std::string& sendaddress(int index) const;
  std::string* mutable_sendaddress(int index);
  void set_sendaddress(int index, const std::string& value);
  void set_sendaddress(int index, std::string&& value);
  void set_sendaddress(int index, const char* value);
  void set_sendaddress(int index, const char* value, size_t size);
  std::string* add_sendaddress();
  void add_sendaddress(const std::string& value);
  void add_sendaddress(std::string&& value);
  void add_sendaddress(const char* value);
  void add_sendaddress(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& sendaddress() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_sendaddress();
  private:
  const std::string& _internal_sendaddress(int index) const;
  std::string* _internal_add_sendaddress();
  public:
  ...
  public:
  void clear_msg();
  const ::BlockMsg& msg() const;
  PROTOBUF_NODISCARD ::BlockMsg* release_msg();
  ::BlockMsg* mutable_msg();
  void set_allocated_msg(::BlockMsg* msg);
  private:
  const ::BlockMsg& _internal_msg() const;
  ::BlockMsg* _internal_mutable_msg();
  public:
  void unsafe_arena_set_allocated_msg(
      ::BlockMsg* msg);
  ::BlockMsg* unsafe_arena_release_msg();

  // @@protoc_insertion_point(class_scope:SendReconnectNodeReq)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> sendaddress_;
...
class SendReconnectNodeAck final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SendReconnectNodeAck) */ {
 public:
  inline SendReconnectNodeAck() : SendReconnectNodeAck(nullptr) {}
  ~SendReconnectNodeAck() override;
  explicit PROTOBUF_CONSTEXPR SendReconnectNodeAck(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SendReconnectNodeAck(const SendReconnectNodeAck& from);
  SendReconnectNodeAck(SendReconnectNodeAck&& from) noexcept
    : SendReconnectNodeAck() {
    *this = ::std::move(from);
  }

  inline SendReconnectNodeAck& operator=(const SendReconnectNodeAck& from) {
    CopyFrom(from);
    return *this;
  }
  inline SendReconnectNodeAck& operator=(SendReconnectNodeAck&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SendReconnectNodeAck& default_instance() {
    return *internal_default_instance();
  }
  static inline const SendReconnectNodeAck* internal_default_instance() {
    return reinterpret_cast<const SendReconnectNodeAck*>(
               &_SendReconnectNodeAck_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(SendReconnectNodeAck& a, SendReconnectNodeAck& b) {
    a.Swap(&b);
  }
  inline void Swap(SendReconnectNodeAck* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SendReconnectNodeAck* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SendReconnectNodeAck* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SendReconnectNodeAck>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SendReconnectNodeAck& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const SendReconnectNodeAck& from) {
    SendReconnectNodeAck::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SendReconnectNodeAck* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "SendReconnectNodeAck";
  }
  protected:
  explicit SendReconnectNodeAck(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kSucsendFieldNumber = 2,
    kMsgIdFieldNumber = 3,
    kMsgFieldNumber = 1,
  };
  // repeated string sucsend = 2;
  int sucsend_size() const;
  private:
  int _internal_sucsend_size() const;
  public:
  void clear_sucsend();
  const std::string& sucsend(int index) const;
  std::string* mutable_sucsend(int index);
  void set_sucsend(int index, const std::string& value);
  void set_sucsend(int index, std::string&& value);
  void set_sucsend(int index, const char* value);
  void set_sucsend(int index, const char* value, size_t size);
  std::string* add_sucsend();
  void add_sucsend(const std::string& value);
  void add_sucsend(std::string&& value);
  void add_sucsend(const char* value);
  void add_sucsend(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& sucsend() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_sucsend();
  private:
  const std::string& _internal_sucsend(int index) const;
  std::string* _internal_add_sucsend();
  public:
  ...
  // @@protoc_insertion_point(class_scope:SendReconnectNodeAck)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> sucsend_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr msg_id_;
    ::BlockMsg* msg_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
...
// repeated string verifyAddrs = 7;
inline int BlockMsg::_internal_verifyaddrs_size() const {
  return _impl_.verifyaddrs_.size();
}
inline int BlockMsg::verifyaddrs_size() const {
  return _internal_verifyaddrs_size();
}
inline void BlockMsg::clear_verifyaddrs() {
  _impl_.verifyaddrs_.Clear();
}
inline std::string* BlockMsg::add_verifyaddrs() {
  std::string* _s = _internal_add_verifyaddrs();
  // @@protoc_insertion_point(field_add_mutable:BlockMsg.verifyAddrs)
  return _s;
}
inline const std::string& BlockMsg::_internal_verifyaddrs(int index) const {
  return _impl_.verifyaddrs_.Get(index);
}
inline const std::string& BlockMsg::verifyaddrs(int index) const {
  // @@protoc_insertion_point(field_get:BlockMsg.verifyAddrs)
  return _internal_verifyaddrs(index);
}
inline std::string* BlockMsg::mutable_verifyaddrs(int index) {
  // @@protoc_insertion_point(field_mutable:BlockMsg.verifyAddrs)
  return _impl_.verifyaddrs_.Mutable(index);
}
inline void BlockMsg::set_verifyaddrs(int index, const std::string& value) {
  _impl_.verifyaddrs_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:BlockMsg.verifyAddrs)
}
inline void BlockMsg::set_verifyaddrs(int index, std::string&& value) {
  _impl_.verifyaddrs_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:BlockMsg.verifyAddrs)
}
inline void BlockMsg::set_verifyaddrs(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.verifyaddrs_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:BlockMsg.verifyAddrs)
}
inline void BlockMsg::set_verifyaddrs(int index, const char* value, size_t size) {
  _impl_.verifyaddrs_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:BlockMsg.verifyAddrs)
}
inline std::string* BlockMsg::_internal_add_verifyaddrs() {
  return _impl_.verifyaddrs_.Add();
}
inline void BlockMsg::add_verifyaddrs(const std::string& value) {
  _impl_.verifyaddrs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:BlockMsg.verifyAddrs)
}
inline void BlockMsg::add_verifyaddrs(std::string&& value) {
  _impl_.verifyaddrs_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:BlockMsg.verifyAddrs)
}
inline void BlockMsg::add_verifyaddrs(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.verifyaddrs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:BlockMsg.verifyAddrs)
}
inline void BlockMsg::add_verifyaddrs(const char* value, size_t size) {
  _impl_.verifyaddrs_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:BlockMsg.verifyAddrs)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
BlockMsg::verifyaddrs() const {
  // @@protoc_insertion_point(field_list:BlockMsg.verifyAddrs)
  return _impl_.verifyaddrs_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
BlockMsg::mutable_verifyaddrs() {
  // @@protoc_insertion_point(field_mutable_list:BlockMsg.verifyAddrs)
  return &_impl_.verifyaddrs_;
}
...
// .BlockMsg msg = 1;
inline bool SendReconnectNodeReq::_internal_has_msg() const {
  return this != internal_default_instance() && _impl_.msg_ != nullptr;
}
inline bool SendReconnectNodeReq::has_msg() const {
  return _internal_has_msg();
}
inline void SendReconnectNodeReq::clear_msg() {
  if (GetArenaForAllocation() == nullptr && _impl_.msg_ != nullptr) {
    delete _impl_.msg_;
  }
  _impl_.msg_ = nullptr;
}
inline const ::BlockMsg& SendReconnectNodeReq::_internal_msg() const {
  const ::BlockMsg* p = _impl_.msg_;
  return p != nullptr ? *p : reinterpret_cast<const ::BlockMsg&>(
      ::_BlockMsg_default_instance_);
}
inline const ::BlockMsg& SendReconnectNodeReq::msg() const {
  // @@protoc_insertion_point(field_get:SendReconnectNodeReq.msg)
  return _internal_msg();
}
inline void SendReconnectNodeReq::unsafe_arena_set_allocated_msg(
    ::BlockMsg* msg) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:SendReconnectNodeReq.msg)
}
inline ::BlockMsg* SendReconnectNodeReq::release_msg() {
  
  ::BlockMsg* temp = _impl_.msg_;
  _impl_.msg_ = nullptr;
...
inline ::BlockMsg* SendReconnectNodeReq::unsafe_arena_release_msg() {
  // @@protoc_insertion_point(field_release:SendReconnectNodeReq.msg)
  
  ::BlockMsg* temp = _impl_.msg_;
  _impl_.msg_ = nullptr;
  return temp;
}
inline ::BlockMsg* SendReconnectNodeReq::_internal_mutable_msg() {
  
  if (_impl_.msg_ == nullptr) {
    auto* p = CreateMaybeMessage<::BlockMsg>(GetArenaForAllocation());
    _impl_.msg_ = p;
  }
  return _impl_.msg_;
}
inline ::BlockMsg* SendReconnectNodeReq::mutable_msg() {
  ::BlockMsg* _msg = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:SendReconnectNodeReq.msg)
  return _msg;
}
inline void SendReconnectNodeReq::set_allocated_msg(::BlockMsg* msg) {
  ...
  _impl_.msg_ = msg;
  // @@protoc_insertion_point(field_set_allocated:SendReconnectNodeReq.msg)
}

// repeated string sendAddress = 2;
inline int SendReconnectNodeReq::_internal_sendaddress_size() const {
  return _impl_.sendaddress_.size();
}
inline int SendReconnectNodeReq::sendaddress_size() const {
  return _internal_sendaddress_size();
}
inline void SendReconnectNodeReq::clear_sendaddress() {
  _impl_.sendaddress_.Clear();
}
inline std::string* SendReconnectNodeReq::add_sendaddress() {
  std::string* _s = _internal_add_sendaddress();
  // @@protoc_insertion_point(field_add_mutable:SendReconnectNodeReq.sendAddress)
  return _s;
}
inline const std::string& SendReconnectNodeReq::_internal_sendaddress(int index) const {
  return _impl_.sendaddress_.Get(index);
}
inline const std::string& SendReconnectNodeReq::sendaddress(int index) const {
  // @@protoc_insertion_point(field_get:SendReconnectNodeReq.sendAddress)
  return _internal_sendaddress(index);
}
inline std::string* SendReconnectNodeReq::mutable_sendaddress(int index) {
  // @@protoc_insertion_point(field_mutable:SendReconnectNodeReq.sendAddress)
  return _impl_.sendaddress_.Mutable(index);
}
inline void SendReconnectNodeReq::set_sendaddress(int index, const std::string& value) {
  _impl_.sendaddress_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:SendReconnectNodeReq.sendAddress)
}
inline void SendReconnectNodeReq::set_sendaddress(int index, std::string&& value) {
  _impl_.sendaddress_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:SendReconnectNodeReq.sendAddress)
}
inline void SendReconnectNodeReq::set_sendaddress(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.sendaddress_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:SendReconnectNodeReq.sendAddress)
}
inline void SendReconnectNodeReq::set_sendaddress(int index, const char* value, size_t size) {
  _impl_.sendaddress_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:SendReconnectNodeReq.sendAddress)
}
inline std::string* SendReconnectNodeReq::_internal_add_sendaddress() {
  return _impl_.sendaddress_.Add();
}
inline void SendReconnectNodeReq::add_sendaddress(const std::string& value) {
  _impl_.sendaddress_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:SendReconnectNodeReq.sendAddress)
}
inline void SendReconnectNodeReq::add_sendaddress(std::string&& value) {
  _impl_.sendaddress_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:SendReconnectNodeReq.sendAddress)
}
inline void SendReconnectNodeReq::add_sendaddress(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.sendaddress_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:SendReconnectNodeReq.sendAddress)
}
inline void SendReconnectNodeReq::add_sendaddress(const char* value, size_t size) {
  _impl_.sendaddress_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:SendReconnectNodeReq.sendAddress)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
SendReconnectNodeReq::sendaddress() const {
  // @@protoc_insertion_point(field_list:SendReconnectNodeReq.sendAddress)
  return _impl_.sendaddress_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
SendReconnectNodeReq::mutable_sendaddress() {
  // @@protoc_insertion_point(field_mutable_list:SendReconnectNodeReq.sendAddress)
  return &_impl_.sendaddress_;
}

// string msg_id = 3;
inline void SendReconnectNodeReq::clear_msg_id() {
  _impl_.msg_id_.ClearToEmpty();
}
inline const std::string& SendReconnectNodeReq::msg_id() const {
  // @@protoc_insertion_point(field_get:SendReconnectNodeReq.msg_id)
  return _internal_msg_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SendReconnectNodeReq::set_msg_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.msg_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:SendReconnectNodeReq.msg_id)
}
inline std::string* SendReconnectNodeReq::mutable_msg_id() {
  std::string* _s = _internal_mutable_msg_id();
  // @@protoc_insertion_point(field_mutable:SendReconnectNodeReq.msg_id)
  return _s;
}
inline const std::string& SendReconnectNodeReq::_internal_msg_id() const {
  return _impl_.msg_id_.Get();
}
inline void SendReconnectNodeReq::_internal_set_msg_id(const std::string& value) {
  
  _impl_.msg_id_.Set(value, GetArenaForAllocation());
}
inline std::string* SendReconnectNodeReq::_internal_mutable_msg_id() {
  
  return _impl_.msg_id_.Mutable(GetArenaForAllocation());
}
inline std::string* SendReconnectNodeReq::release_msg_id() {
  // @@protoc_insertion_point(field_release:SendReconnectNodeReq.msg_id)
  return _impl_.msg_id_.Release();
}
inline void SendReconnectNodeReq::set_allocated_msg_id(std::string* msg_id) {
  if (msg_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:SendReconnectNodeReq.msg_id)
}
...
// .BlockMsg msg = 1;
inline bool SendReconnectNodeAck::_internal_has_msg() const {
  return this != internal_default_instance() && _impl_.msg_ != nullptr;
}
inline bool SendReconnectNodeAck::has_msg() const {
  return _internal_has_msg();
}
inline void SendReconnectNodeAck::clear_msg() {
  if (GetArenaForAllocation() == nullptr && _impl_.msg_ != nullptr) {
    delete _impl_.msg_;
  }
  _impl_.msg_ = nullptr;
}
inline const ::BlockMsg& SendReconnectNodeAck::_internal_msg() const {
  const ::BlockMsg* p = _impl_.msg_;
  return p != nullptr ? *p : reinterpret_cast<const ::BlockMsg&>(
      ::_BlockMsg_default_instance_);
}
inline const ::BlockMsg& SendReconnectNodeAck::msg() const {
  // @@protoc_insertion_point(field_get:SendReconnectNodeAck.msg)
  return _internal_msg();
}
inline void SendReconnectNodeAck::unsafe_arena_set_allocated_msg(
    ::BlockMsg* msg) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.msg_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:SendReconnectNodeAck.msg)
}
inline ::BlockMsg* SendReconnectNodeAck::release_msg() {
...
inline ::BlockMsg* SendReconnectNodeAck::unsafe_arena_release_msg() {
  // @@protoc_insertion_point(field_release:SendReconnectNodeAck.msg)
  
  ::BlockMsg* temp = _impl_.msg_;
  _impl_.msg_ = nullptr;
  return temp;
}
inline ::BlockMsg* SendReconnectNodeAck::_internal_mutable_msg() {
...
inline ::BlockMsg* SendReconnectNodeAck::mutable_msg() {
  ::BlockMsg* _msg = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:SendReconnectNodeAck.msg)
  return _msg;
}
inline void SendReconnectNodeAck::set_allocated_msg(::BlockMsg* msg) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.msg_;
  }
  ...
  _impl_.msg_ = msg;
  // @@protoc_insertion_point(field_set_allocated:SendReconnectNodeAck.msg)
}

// repeated string sucsend = 2;
inline int SendReconnectNodeAck::_internal_sucsend_size() const {
  return _impl_.sucsend_.size();
}
inline int SendReconnectNodeAck::sucsend_size() const {
  return _internal_sucsend_size();
}
inline void SendReconnectNodeAck::clear_sucsend() {
  _impl_.sucsend_.Clear();
}
inline std::string* SendReconnectNodeAck::add_sucsend() {
  std::string* _s = _internal_add_sucsend();
  // @@protoc_insertion_point(field_add_mutable:SendReconnectNodeAck.sucsend)
  return _s;
}
inline const std::string& SendReconnectNodeAck::_internal_sucsend(int index) const {
  return _impl_.sucsend_.Get(index);
}
inline const std::string& SendReconnectNodeAck::sucsend(int index) const {
  // @@protoc_insertion_point(field_get:SendReconnectNodeAck.sucsend)
  return _internal_sucsend(index);
}
inline std::string* SendReconnectNodeAck::mutable_sucsend(int index) {
  // @@protoc_insertion_point(field_mutable:SendReconnectNodeAck.sucsend)
  return _impl_.sucsend_.Mutable(index);
}
inline void SendReconnectNodeAck::set_sucsend(int index, const std::string& value) {
  _impl_.sucsend_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:SendReconnectNodeAck.sucsend)
}
inline void SendReconnectNodeAck::set_sucsend(int index, std::string&& value) {
  _impl_.sucsend_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:SendReconnectNodeAck.sucsend)
}
inline void SendReconnectNodeAck::set_sucsend(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.sucsend_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:SendReconnectNodeAck.sucsend)
}
inline void SendReconnectNodeAck::set_sucsend(int index, const char* value, size_t size) {
  _impl_.sucsend_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:SendReconnectNodeAck.sucsend)
}
inline std::string* SendReconnectNodeAck::_internal_add_sucsend() {
  return _impl_.sucsend_.Add();
}
inline void SendReconnectNodeAck::add_sucsend(const std::string& value) {
  _impl_.sucsend_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:SendReconnectNodeAck.sucsend)
}
inline void SendReconnectNodeAck::add_sucsend(std::string&& value) {
  _impl_.sucsend_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:SendReconnectNodeAck.sucsend)
}
inline void SendReconnectNodeAck::add_sucsend(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.sucsend_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:SendReconnectNodeAck.sucsend)
}
inline void SendReconnectNodeAck::add_sucsend(const char* value, size_t size) {
  _impl_.sucsend_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:SendReconnectNodeAck.sucsend)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
SendReconnectNodeAck::sucsend() const {
  // @@protoc_insertion_point(field_list:SendReconnectNodeAck.sucsend)
  return _impl_.sucsend_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
SendReconnectNodeAck::mutable_sucsend() {
  // @@protoc_insertion_point(field_mutable_list:SendReconnectNodeAck.sucsend)
  return &_impl_.sucsend_;
}

// string msg_id = 3;
inline void SendReconnectNodeAck::clear_msg_id() {
  _impl_.msg_id_.ClearToEmpty();
}
inline const std::string& SendReconnectNodeAck::msg_id() const {
  // @@protoc_insertion_point(field_get:SendReconnectNodeAck.msg_id)
  return _internal_msg_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SendReconnectNodeAck::set_msg_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.msg_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:SendReconnectNodeAck.msg_id)
}
inline std::string* SendReconnectNodeAck::mutable_msg_id() {
  std::string* _s = _internal_mutable_msg_id();
  // @@protoc_insertion_point(field_mutable:SendReconnectNodeAck.msg_id)
  return _s;
}
inline const std::string& SendReconnectNodeAck::_internal_msg_id() const {
  return _impl_.msg_id_.Get();
}
inline void SendReconnectNodeAck::_internal_set_msg_id(const std::string& value) {
  
  _impl_.msg_id_.Set(value, GetArenaForAllocation());
}
inline std::string* SendReconnectNodeAck::_internal_mutable_msg_id() {
  
  return _impl_.msg_id_.Mutable(GetArenaForAllocation());
}
inline std::string* SendReconnectNodeAck::release_msg_id() {
  // @@protoc_insertion_point(field_release:SendReconnectNodeAck.msg_id)
  return _impl_.msg_id_.Release();
}
inline void SendReconnectNodeAck::set_allocated_msg_id(std::string* msg_id) {
  if (msg_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:SendReconnectNodeAck.msg_id)
}
