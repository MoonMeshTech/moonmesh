...
PROTOBUF_CONSTEXPR CTxUtxos::CTxUtxos(
    ::_pbi::ConstantInitialized): _impl_{
  ...
  , /*decltype(_impl_.gasutxo_)*/int64_t{0}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct CTxUtxosDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CTxUtxosDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~CTxUtxosDefaultTypeInternal() {}
  union {
    CTxUtxos _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CTxUtxosDefaultTypeInternal _CTxUtxos_default_instance_;
...
const uint32_t TableStruct_transaction_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::CTxUtxos, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::CTxUtxos, _impl_.owner_),
  PROTOBUF_FIELD_OFFSET(::CTxUtxos, _impl_.vin_),
  PROTOBUF_FIELD_OFFSET(::CTxUtxos, _impl_.vout_),
  PROTOBUF_FIELD_OFFSET(::CTxUtxos, _impl_.multisign_),
  PROTOBUF_FIELD_OFFSET(::CTxUtxos, _impl_.assettype_),
  PROTOBUF_FIELD_OFFSET(::CTxUtxos, _impl_.gasutxo_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::CTransaction, _impl_.utxos_),
  PROTOBUF_FIELD_OFFSET(::CTransaction, _impl_.gastx_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 26, -1, -1, sizeof(::CTxUtxos)},
  { 38, -1, -1, sizeof(::CTransaction)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::_CTxUtxos_default_instance_._instance,
...
const char descriptor_table_protodef_transaction_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "nsus\030\007 \001(\r\022\016\n\006txType\030\010 \001(\r\022\014\n\004data\030\t \001(\t"
  "\022\014\n\004info\030\n \001(\t\022\032\n\nverifySign\030\013 \003(\0132\006.CSi"
  "gn\022\020\n\010reserve0\030\014 \001(\t\022\020\n\010reserve1\030\r \001(\t\022\030"
  "\n\005utxos\030\016 \003(\0132\t.CTxUtxos\022\r\n\005gasTx\030\017 \001(\r\022"
  "\r\n\005nonce\030\020 \001(\004b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_transaction_2eproto = {
    false, false, 662, descriptor_table_protodef_transaction_2eproto,
    "transaction.proto",
...
class CTxUtxos::_Internal {
 public:
};

void CTxUtxos::clear_multisign() {
  _impl_.multisign_.Clear();
}
CTxUtxos::CTxUtxos(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:CTxUtxos)
}
CTxUtxos::CTxUtxos(const CTxUtxos& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  CTxUtxos* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_assettype().empty()) {
    _this->_impl_.assettype_.Set(from._internal_assettype(), 
      _this->GetArenaForAllocation());
  }
  _this->_impl_.gasutxo_ = from._impl_.gasutxo_;
  // @@protoc_insertion_point(copy_constructor:CTxUtxos)
}

inline void CTxUtxos::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
CTxUtxos::~CTxUtxos() {
  // @@protoc_insertion_point(destructor:CTxUtxos)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void CTxUtxos::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
void CTxUtxos::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void CTxUtxos::Clear() {
// @@protoc_insertion_point(message_clear_start:CTxUtxos)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* CTxUtxos::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ...
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "CTxUtxos.owner"));
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else
          goto handle_unusual;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "CTxUtxos.assetType"));
        } else
          goto handle_unusual;
        continue;
      // int64 GasUtxo = 6;
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          _impl_.gasutxo_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CTxUtxos::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:CTxUtxos)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // string assetType = 5;
  if (!this->_internal_assettype().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_assettype().data(), static_cast<int>(this->_internal_assettype().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "CTxUtxos.assetType");
    target = stream->WriteStringMaybeAliased(
        5, this->_internal_assettype(), target);
  }

  // int64 GasUtxo = 6;
  if (this->_internal_gasutxo() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(6, this->_internal_gasutxo(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:CTxUtxos)
  return target;
}

size_t CTxUtxos::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:CTxUtxos)
  size_t total_size = 0;
  ...
  // int64 GasUtxo = 6;
  if (this->_internal_gasutxo() != 0) {
    total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this->_internal_gasutxo());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_impl_._cached_size_);
}

const ::PROTOBUF_NAMESPACE_ID::Message::ClassData CTxUtxos::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    CTxUtxos::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*CTxUtxos::GetClassData() const { return &_class_data_; }


void CTxUtxos::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CTxUtxos*>(&to_msg);
  auto& from = static_cast<const CTxUtxos&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:CTxUtxos)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from._internal_gasutxo() != 0) {
    _this->_internal_set_gasutxo(from._internal_gasutxo());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void CTxUtxos::CopyFrom(const CTxUtxos& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:CTxUtxos)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CTxUtxos::IsInitialized() const {
  return true;
}

void CTxUtxos::InternalSwap(CTxUtxos* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ...
  swap(_impl_.gasutxo_, other->_impl_.gasutxo_);
}

::PROTOBUF_NAMESPACE_ID::Metadata CTxUtxos::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_transaction_2eproto_getter, &descriptor_table_transaction_2eproto_once,
...
CTransaction::CTransaction(const CTransaction& from)
  ...
  ::memcpy(&_impl_.time_, &from._impl_.time_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.gastx_) -
    reinterpret_cast<char*>(&_impl_.time_)) + sizeof(_impl_.gastx_));
...
// @@protoc_insertion_point(message_clear_start:CTransaction)
  ...
  ::memset(&_impl_.time_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.gastx_) -
      reinterpret_cast<char*>(&_impl_.time_)) + sizeof(_impl_.gastx_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 120)) {
          _impl_.gastx_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CTransaction::_InternalSerialize(
  ...
  if (this->_internal_consensus() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(7, this->_internal_consensus(), target);
  }

  // uint32 txType = 8;
  if (this->_internal_txtype() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(8, this->_internal_txtype(), target);
  }
  ...
  if (!this->_internal_reserve0().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        12, this->_internal_reserve0(), target);
  }
  ...
  if (!this->_internal_reserve1().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        13, this->_internal_reserve1(), target);
  }
  ...
  // uint32 gasTx = 15;
  if (this->_internal_gastx() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(15, this->_internal_gastx(), target);
  }

  // uint64 nonce = 16;
  if (this->_internal_nonce() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(16, this->_internal_nonce(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CTransaction)
  ...
  // uint32 gasTx = 15;
  if (this->_internal_gastx() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_gastx());
  }
...
void CTransaction::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_gastx() != 0) {
    _this->_internal_set_gastx(from._internal_gastx());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CTransaction::InternalSwap(CTransaction* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CTransaction, _impl_.gastx_)
      + sizeof(CTransaction::_impl_.gastx_)
      - PROTOBUF_FIELD_OFFSET(CTransaction, _impl_.time_)>(
...
template<> PROTOBUF_NOINLINE ::CTxUtxos*
Arena::CreateMaybeMessage< ::CTxUtxos >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CTxUtxos >(arena);
}
