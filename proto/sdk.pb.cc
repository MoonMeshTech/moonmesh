...
PROTOBUF_CONSTEXPR SDKBonusamout::SDKBonusamout(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.address_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.delegating_amount_)*/uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_sdk_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::SDKBonusamout, _impl_.delegating_amount_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::GetSDKAck, _impl_.delegatingedaddr_),
  PROTOBUF_FIELD_OFFSET(::GetSDKAck, _impl_.bonustx_),
  PROTOBUF_FIELD_OFFSET(::GetSDKAck, _impl_.bonusaddrdelegateutxos_),
  ...
  PROTOBUF_FIELD_OFFSET(::GetSDKAck, _impl_.totaldelegating_),
  ...
  PROTOBUF_FIELD_OFFSET(::GetSDKAck, _impl_.claimdelegatingedaddr_),
  PROTOBUF_FIELD_OFFSET(::GetSDKAck, _impl_.claimbonusaddrdelegateutxos_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_sdk_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "isten_port\030\t \001(\r\022\021\n\tpublic_ip\030\n \001(\r\022\023\n\013p"
  "ublic_port\030\013 \001(\r\022\016\n\006height\030\014 \001(\r\022\022\n\ntime"
  "_stamp\030\r \001(\004\022\017\n\007version\030\016 \001(\t\"\354\004\n\tGetSDK"
  ...
  "(\0132\010.SDKUtxo\022\016\n\006blocks\030\006 \003(\014\022#\n\013bonusamo"
  "unt\030\010 \003(\0132\016.SDKBonusamout\022\036\n\010pledgetx\030\t "
  "\003(\0132\014.SDKPledgeTx\022\022\n\npledgeaddr\030\n \003(\t\022\022\n"
  "\npledgeutxo\030\013 \003(\t\022\021\n\tBonusAddr\030\014 \003(\t\022\030\n\020"
  "DelegatingedAddr\030\r \003(\t\022\034\n\007BonusTx\030\016 \003(\0132"
  "\013.SDKBonusTx\022\036\n\026BonusAddrDelegateUtxos\030\017"
  " \003(\t\022\031\n\007claimtx\030\020 \003(\0132\010.Claimtx\022*\n\020abnor"
  "maladdr_cnt\030\021 \003(\0132\020.AbnormalAddrCnt\022\n\n\002M"
  "2\030\022 \001(\004\022\027\n\017Totaldelegating\030\023 \001(\004\022\030\n\020Tota"
  "lAwardAmount\030\024 \001(\004\022\036\n\010nodeinfo\030\026 \003(\0132\014.S"
  "DKNodeInfo\022\014\n\004type\030\027 \001(\004\022&\n\014ClaimBonusTx"
  "\030\030 \003(\0132\020.SDKClaimBonusTx\022\035\n\025ClaimDelegat"
  "ingedAddr\030\032 \003(\t\022#\n\033ClaimBonusAddrDelegat"
  "eUtxos\030\033 \003(\t\";\n\027SDKNormalTransactionReq\022"
  "\017\n\007version\030\001 \001(\t\022\017\n\007address\030\002 \003(\t\"\217\002\n\027SD"
  "KNormalTransactionAck\022\017\n\007version\030\001 \001(\t\022\014"
  "\n\004code\030\002 \001(\005\022\017\n\007message\030\003 \001(\t\022\016\n\006height\030"
  "\004 \001(\004\022\027\n\005utxos\030\005 \003(\0132\010.SDKUtxo\022\016\n\006blocks"
  "\030\006 \003(\014\022#\n\013bonusamount\030\007 \003(\0132\016.SDKBonusam"
  "out\022\036\n\010pledgetx\030\010 \003(\0132\014.SDKPledgeTx\022\022\n\np"
  "ledgeaddr\030\t \003(\t\022\022\n\npledgeutxo\030\n \003(\t\022\036\n\010n"
  "odeinfo\030\013 \003(\0132\014.SDKNodeInfo\"v\n\024SDKContra"
  "ctDeployReq\022\017\n\007version\030\001 \001(\t\022\017\n\007address\030"
  "\002 \001(\t\022\025\n\rdeploy_amount\030\003 \001(\t\022\025\n\rnContrac"
  "tType\030\004 \001(\005\022\016\n\006pubStr\030\005 \001(\t\"\271\001\n\024SDKContr"
  "actDeployAck\022\017\n\007version\030\001 \001(\t\022\014\n\004code\030\002 "
  "\001(\005\022\017\n\007message\030\003 \001(\t\022\n\n\002tx\030\004 \001(\014\022\013\n\003top\030"
  "\005 \001(\004\022\n\n\002ip\030\006 \001(\004\022\014\n\004port\030\007 \001(\004\022\'\n\020isNee"
  "dAgent_flag\030\010 \001(\0162\r.vrfAgentType\022\025\n\007vrfI"
  "nfo\030\t \001(\0132\004.Vrf\"a\n\022SDKContractCallReq\022\017\n"
  "\007version\030\001 \001(\t\022\020\n\010fromaddr\030\002 \001(\t\022\016\n\006toad"
  "dr\030\003 \001(\t\022\030\n\020deploy_strTxHash\030\004 \001(\004\"\267\001\n\022S"
  "DKContractCallAck\022\017\n\007version\030\001 \001(\t\022\014\n\004co"
  "de\030\002 \001(\005\022\017\n\007message\030\003 \001(\t\022\n\n\002tx\030\004 \001(\014\022\013\n"
  "\003top\030\005 \001(\004\022\n\n\002ip\030\006 \001(\004\022\014\n\004port\030\007 \001(\004\022\'\n\020"
  "isNeedAgent_flag\030\010 \001(\0162\r.vrfAgentType\022\025\n"
  "\007vrfInfo\030\t \001(\0132\004.Vrf*o\n\014vrfAgentType\022\030\n\024"
  "vrfAgentType_defalut\020\000\022\024\n\020vrfAgentType_v"
  "rf\020\001\022\026\n\022vrfAgentType_local\020\002\022\027\n\023vrfAgent"
  "Type_unknow\020\003b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_sdk_2eproto = {
    false, false, 2461, descriptor_table_protodef_sdk_2eproto,
    "sdk.proto",
...
SDKBonusamout::SDKBonusamout(const SDKBonusamout& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.address_){}
    , decltype(_impl_.delegating_amount_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  _this->_impl_.delegating_amount_ = from._impl_.delegating_amount_;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _impl_.delegating_amount_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SDKBonusamout::_InternalSerialize(
  ...
  // uint64 delegating_amount = 2;
  if (this->_internal_delegating_amount() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(2, this->_internal_delegating_amount(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:SDKBonusamout)
  ...
  // uint64 delegating_amount = 2;
  if (this->_internal_delegating_amount() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_delegating_amount());
  }
...
void SDKBonusamout::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_delegating_amount() != 0) {
    _this->_internal_set_delegating_amount(from._internal_delegating_amount());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void SDKBonusamout::InternalSwap(SDKBonusamout* other) {
  ...
  swap(_impl_.delegating_amount_, other->_impl_.delegating_amount_);
}
...
GetSDKAck::GetSDKAck(const GetSDKAck& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.delegatingedaddr_){from._impl_.delegatingedaddr_}
    , decltype(_impl_.bonustx_){from._impl_.bonustx_}
    , decltype(_impl_.bonusaddrdelegateutxos_){from._impl_.bonusaddrdelegateutxos_}
    ...
    , decltype(_impl_.claimdelegatingedaddr_){from._impl_.claimdelegatingedaddr_}
    , decltype(_impl_.claimbonusaddrdelegateutxos_){from._impl_.claimbonusaddrdelegateutxos_}
    , decltype(_impl_.version_){}
    , decltype(_impl_.message_){}
    , decltype(_impl_.height_){}
    , decltype(_impl_.m2_){}
    , decltype(_impl_.totaldelegating_){}
...
inline void GetSDKAck::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.delegatingedaddr_){arena}
    , decltype(_impl_.bonustx_){arena}
    , decltype(_impl_.bonusaddrdelegateutxos_){arena}
    ...
    , decltype(_impl_.claimdelegatingedaddr_){arena}
    , decltype(_impl_.claimbonusaddrdelegateutxos_){arena}
    , decltype(_impl_.version_){}
    , decltype(_impl_.message_){}
    , decltype(_impl_.height_){uint64_t{0u}}
    , decltype(_impl_.m2_){uint64_t{0u}}
...
inline void GetSDKAck::SharedDtor() {
  ...
  _impl_.delegatingedaddr_.~RepeatedPtrField();
  _impl_.bonustx_.~RepeatedPtrField();
  _impl_.bonusaddrdelegateutxos_.~RepeatedPtrField();
  ...
  _impl_.claimdelegatingedaddr_.~RepeatedPtrField();
  _impl_.claimbonusaddrdelegateutxos_.~RepeatedPtrField();
  _impl_.version_.Destroy();
    ...
    switch (tag >> 3) {
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 106)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_delegatingedaddr();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "GetSDKAck.DelegatingedAddr"));
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 122)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_bonusaddrdelegateutxos();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "GetSDKAck.BonusAddrDelegateUtxos"));
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 19:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 152)) {
          _impl_.totaldelegating_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 26:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 210)) {
          ...
          do {
            ptr += 2;
            auto str = _internal_add_claimdelegatingedaddr();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "GetSDKAck.ClaimDelegatingedAddr"));
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 27:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 218)) {
          ...
          do {
            ptr += 2;
            auto str = _internal_add_claimbonusaddrdelegateutxos();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "GetSDKAck.ClaimBonusAddrDelegateUtxos"));
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* GetSDKAck::_InternalSerialize(
  ...
  // repeated string DelegatingedAddr = 13;
  for (int i = 0, n = this->_internal_delegatingedaddr_size(); i < n; i++) {
    const auto& s = this->_internal_delegatingedaddr(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      s.data(), static_cast<int>(s.length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "GetSDKAck.DelegatingedAddr");
  ...
  // repeated string BonusAddrDelegateUtxos = 15;
  for (int i = 0, n = this->_internal_bonusaddrdelegateutxos_size(); i < n; i++) {
    const auto& s = this->_internal_bonusaddrdelegateutxos(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      s.data(), static_cast<int>(s.length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "GetSDKAck.BonusAddrDelegateUtxos");
  ...
  // uint64 Totaldelegating = 19;
  if (this->_internal_totaldelegating() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(19, this->_internal_totaldelegating(), target);
  }
  ...
  // repeated string ClaimDelegatingedAddr = 26;
  for (int i = 0, n = this->_internal_claimdelegatingedaddr_size(); i < n; i++) {
    const auto& s = this->_internal_claimdelegatingedaddr(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      s.data(), static_cast<int>(s.length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "GetSDKAck.ClaimDelegatingedAddr");
    target = stream->WriteString(26, s, target);
  }

  // repeated string ClaimBonusAddrDelegateUtxos = 27;
  for (int i = 0, n = this->_internal_claimbonusaddrdelegateutxos_size(); i < n; i++) {
    const auto& s = this->_internal_claimbonusaddrdelegateutxos(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      s.data(), static_cast<int>(s.length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "GetSDKAck.ClaimBonusAddrDelegateUtxos");
...
// @@protoc_insertion_point(message_byte_size_start:GetSDKAck)
  ...
  // repeated string DelegatingedAddr = 13;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.delegatingedaddr_.size());
  for (int i = 0, n = _impl_.delegatingedaddr_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.delegatingedaddr_.Get(i));
  }
  ...
  // repeated string BonusAddrDelegateUtxos = 15;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.bonusaddrdelegateutxos_.size());
  for (int i = 0, n = _impl_.bonusaddrdelegateutxos_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.bonusaddrdelegateutxos_.Get(i));
  }
  ...
  // repeated string ClaimDelegatingedAddr = 26;
  total_size += 2 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.claimdelegatingedaddr_.size());
  for (int i = 0, n = _impl_.claimdelegatingedaddr_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.claimdelegatingedaddr_.Get(i));
  }

  // repeated string ClaimBonusAddrDelegateUtxos = 27;
  total_size += 2 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.claimbonusaddrdelegateutxos_.size());
  for (int i = 0, n = _impl_.claimbonusaddrdelegateutxos_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.claimbonusaddrdelegateutxos_.Get(i));
  }
  ...
  if (this->_internal_totaldelegating() != 0) {
    total_size += 2 +
      ::_pbi::WireFormatLite::UInt64Size(
        this->_internal_totaldelegating());
  }
...
void GetSDKAck::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.delegatingedaddr_.MergeFrom(from._impl_.delegatingedaddr_);
  _this->_impl_.bonustx_.MergeFrom(from._impl_.bonustx_);
  _this->_impl_.bonusaddrdelegateutxos_.MergeFrom(from._impl_.bonusaddrdelegateutxos_);
  ...
  _this->_impl_.claimdelegatingedaddr_.MergeFrom(from._impl_.claimdelegatingedaddr_);
  _this->_impl_.claimbonusaddrdelegateutxos_.MergeFrom(from._impl_.claimbonusaddrdelegateutxos_);
  if (!from._internal_version().empty()) {
    _this->_internal_set_version(from._internal_version());
  }
  if (!from._internal_message().empty()) {
  ...
  if (from._internal_totaldelegating() != 0) {
    _this->_internal_set_totaldelegating(from._internal_totaldelegating());
  }
...
void GetSDKAck::InternalSwap(GetSDKAck* other) {
  ...
  _impl_.delegatingedaddr_.InternalSwap(&other->_impl_.delegatingedaddr_);
  _impl_.bonustx_.InternalSwap(&other->_impl_.bonustx_);
  _impl_.bonusaddrdelegateutxos_.InternalSwap(&other->_impl_.bonusaddrdelegateutxos_);
  ...
  _impl_.claimdelegatingedaddr_.InternalSwap(&other->_impl_.claimdelegatingedaddr_);
  _impl_.claimbonusaddrdelegateutxos_.InternalSwap(&other->_impl_.claimbonusaddrdelegateutxos_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.version_, lhs_arena,
      &other->_impl_.version_, rhs_arena
  );
