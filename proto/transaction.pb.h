...
class CTxUtxos;
struct CTxUtxosDefaultTypeInternal;
extern CTxUtxosDefaultTypeInternal _CTxUtxos_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::CTxUtxos* Arena::CreateMaybeMessage<::CTxUtxos>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class CTxUtxos final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CTxUtxos) */ {
 public:
  inline CTxUtxos() : CTxUtxos(nullptr) {}
  ~CTxUtxos() override;
  explicit PROTOBUF_CONSTEXPR CTxUtxos(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CTxUtxos(const CTxUtxos& from);
  CTxUtxos(CTxUtxos&& from) noexcept
    : CTxUtxos() {
    *this = ::std::move(from);
  }

  inline CTxUtxos& operator=(const CTxUtxos& from) {
    CopyFrom(from);
    return *this;
  }
  inline CTxUtxos& operator=(CTxUtxos&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CTxUtxos& default_instance() {
    return *internal_default_instance();
  }
  static inline const CTxUtxos* internal_default_instance() {
    return reinterpret_cast<const CTxUtxos*>(
               &_CTxUtxos_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(CTxUtxos& a, CTxUtxos& b) {
    a.Swap(&b);
  }
  inline void Swap(CTxUtxos* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CTxUtxos* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CTxUtxos* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CTxUtxos>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CTxUtxos& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CTxUtxos& from) {
    CTxUtxos::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CTxUtxos* other);
  ...
  protected:
  explicit CTxUtxos(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // int64 GasUtxo = 6;
  void clear_gasutxo();
  int64_t gasutxo() const;
  void set_gasutxo(int64_t value);
  private:
  int64_t _internal_gasutxo() const;
  void _internal_set_gasutxo(int64_t value);
  public:

  // @@protoc_insertion_point(class_scope:CTxUtxos)
 private:
  class _Internal;
...
class CTransaction final :
 ...
 public:
  ...
  enum : int {
    kVerifySignFieldNumber = 11,
    kUtxosFieldNumber = 14,
    kIdentityFieldNumber = 4,
    kHashFieldNumber = 5,
    kTypeFieldNumber = 6,
    kDataFieldNumber = 9,
    kInfoFieldNumber = 10,
    kReserve0FieldNumber = 12,
    kReserve1FieldNumber = 13,
    kTimeFieldNumber = 2,
    kVersionFieldNumber = 1,
    kNFieldNumber = 3,
    kConsensusFieldNumber = 7,
    kTxTypeFieldNumber = 8,
    kNonceFieldNumber = 16,
    kGasTxFieldNumber = 15,
  };
  // repeated .CSign verifySign = 11;
  ...
  public:
  void clear_utxos();
  ::CTxUtxos* mutable_utxos(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxUtxos >*
      mutable_utxos();
  private:
  const ::CTxUtxos& _internal_utxos(int index) const;
  ::CTxUtxos* _internal_add_utxos();
  public:
  const ::CTxUtxos& utxos(int index) const;
  ::CTxUtxos* add_utxos();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxUtxos >&
      utxos() const;
  ...
  // uint32 gasTx = 15;
  void clear_gastx();
  uint32_t gastx() const;
  void set_gastx(uint32_t value);
  private:
  uint32_t _internal_gastx() const;
  void _internal_set_gastx(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxUtxos > utxos_;
...
// repeated string owner = 1;
inline int CTxUtxos::_internal_owner_size() const {
  return _impl_.owner_.size();
}
inline int CTxUtxos::owner_size() const {
  return _internal_owner_size();
}
inline void CTxUtxos::clear_owner() {
  _impl_.owner_.Clear();
}
inline std::string* CTxUtxos::add_owner() {
  std::string* _s = _internal_add_owner();
  // @@protoc_insertion_point(field_add_mutable:CTxUtxos.owner)
  return _s;
}
inline const std::string& CTxUtxos::_internal_owner(int index) const {
  return _impl_.owner_.Get(index);
}
inline const std::string& CTxUtxos::owner(int index) const {
  // @@protoc_insertion_point(field_get:CTxUtxos.owner)
  return _internal_owner(index);
}
inline std::string* CTxUtxos::mutable_owner(int index) {
  // @@protoc_insertion_point(field_mutable:CTxUtxos.owner)
  return _impl_.owner_.Mutable(index);
}
inline void CTxUtxos::set_owner(int index, const std::string& value) {
  _impl_.owner_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:CTxUtxos.owner)
}
inline void CTxUtxos::set_owner(int index, std::string&& value) {
  _impl_.owner_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:CTxUtxos.owner)
}
inline void CTxUtxos::set_owner(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.owner_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:CTxUtxos.owner)
}
inline void CTxUtxos::set_owner(int index, const char* value, size_t size) {
  _impl_.owner_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:CTxUtxos.owner)
}
inline std::string* CTxUtxos::_internal_add_owner() {
  return _impl_.owner_.Add();
}
inline void CTxUtxos::add_owner(const std::string& value) {
  _impl_.owner_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:CTxUtxos.owner)
}
inline void CTxUtxos::add_owner(std::string&& value) {
  _impl_.owner_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:CTxUtxos.owner)
}
inline void CTxUtxos::add_owner(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.owner_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:CTxUtxos.owner)
}
inline void CTxUtxos::add_owner(const char* value, size_t size) {
  _impl_.owner_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:CTxUtxos.owner)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
CTxUtxos::owner() const {
  // @@protoc_insertion_point(field_list:CTxUtxos.owner)
  return _impl_.owner_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
CTxUtxos::mutable_owner() {
  // @@protoc_insertion_point(field_mutable_list:CTxUtxos.owner)
  return &_impl_.owner_;
}

// repeated .CTxInput vin = 2;
inline int CTxUtxos::_internal_vin_size() const {
  return _impl_.vin_.size();
}
inline int CTxUtxos::vin_size() const {
  return _internal_vin_size();
}
inline void CTxUtxos::clear_vin() {
  _impl_.vin_.Clear();
}
inline ::CTxInput* CTxUtxos::mutable_vin(int index) {
  // @@protoc_insertion_point(field_mutable:CTxUtxos.vin)
  return _impl_.vin_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxInput >*
CTxUtxos::mutable_vin() {
  // @@protoc_insertion_point(field_mutable_list:CTxUtxos.vin)
  return &_impl_.vin_;
}
inline const ::CTxInput& CTxUtxos::_internal_vin(int index) const {
  return _impl_.vin_.Get(index);
}
inline const ::CTxInput& CTxUtxos::vin(int index) const {
  // @@protoc_insertion_point(field_get:CTxUtxos.vin)
  return _internal_vin(index);
}
inline ::CTxInput* CTxUtxos::_internal_add_vin() {
  return _impl_.vin_.Add();
}
inline ::CTxInput* CTxUtxos::add_vin() {
  ::CTxInput* _add = _internal_add_vin();
  // @@protoc_insertion_point(field_add:CTxUtxos.vin)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxInput >&
CTxUtxos::vin() const {
  // @@protoc_insertion_point(field_list:CTxUtxos.vin)
  return _impl_.vin_;
}

// repeated .CTxOutput vout = 3;
inline int CTxUtxos::_internal_vout_size() const {
  return _impl_.vout_.size();
}
inline int CTxUtxos::vout_size() const {
  return _internal_vout_size();
}
inline void CTxUtxos::clear_vout() {
  _impl_.vout_.Clear();
}
inline ::CTxOutput* CTxUtxos::mutable_vout(int index) {
  // @@protoc_insertion_point(field_mutable:CTxUtxos.vout)
  return _impl_.vout_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxOutput >*
CTxUtxos::mutable_vout() {
  // @@protoc_insertion_point(field_mutable_list:CTxUtxos.vout)
  return &_impl_.vout_;
}
inline const ::CTxOutput& CTxUtxos::_internal_vout(int index) const {
  return _impl_.vout_.Get(index);
}
inline const ::CTxOutput& CTxUtxos::vout(int index) const {
  // @@protoc_insertion_point(field_get:CTxUtxos.vout)
  return _internal_vout(index);
}
inline ::CTxOutput* CTxUtxos::_internal_add_vout() {
  return _impl_.vout_.Add();
}
inline ::CTxOutput* CTxUtxos::add_vout() {
  ::CTxOutput* _add = _internal_add_vout();
  // @@protoc_insertion_point(field_add:CTxUtxos.vout)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxOutput >&
CTxUtxos::vout() const {
  // @@protoc_insertion_point(field_list:CTxUtxos.vout)
  return _impl_.vout_;
}

// repeated .CSign multiSign = 4;
inline int CTxUtxos::_internal_multisign_size() const {
  return _impl_.multisign_.size();
}
inline int CTxUtxos::multisign_size() const {
  return _internal_multisign_size();
}
inline ::CSign* CTxUtxos::mutable_multisign(int index) {
  // @@protoc_insertion_point(field_mutable:CTxUtxos.multiSign)
  return _impl_.multisign_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSign >*
CTxUtxos::mutable_multisign() {
  // @@protoc_insertion_point(field_mutable_list:CTxUtxos.multiSign)
  return &_impl_.multisign_;
}
inline const ::CSign& CTxUtxos::_internal_multisign(int index) const {
  return _impl_.multisign_.Get(index);
}
inline const ::CSign& CTxUtxos::multisign(int index) const {
  // @@protoc_insertion_point(field_get:CTxUtxos.multiSign)
  return _internal_multisign(index);
}
inline ::CSign* CTxUtxos::_internal_add_multisign() {
  return _impl_.multisign_.Add();
}
inline ::CSign* CTxUtxos::add_multisign() {
  ::CSign* _add = _internal_add_multisign();
  // @@protoc_insertion_point(field_add:CTxUtxos.multiSign)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSign >&
CTxUtxos::multisign() const {
  // @@protoc_insertion_point(field_list:CTxUtxos.multiSign)
  return _impl_.multisign_;
}

// string assetType = 5;
inline void CTxUtxos::clear_assettype() {
  _impl_.assettype_.ClearToEmpty();
}
inline const std::string& CTxUtxos::assettype() const {
  // @@protoc_insertion_point(field_get:CTxUtxos.assetType)
  return _internal_assettype();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CTxUtxos::set_assettype(ArgT0&& arg0, ArgT... args) {
 
 _impl_.assettype_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:CTxUtxos.assetType)
}
inline std::string* CTxUtxos::mutable_assettype() {
  std::string* _s = _internal_mutable_assettype();
  // @@protoc_insertion_point(field_mutable:CTxUtxos.assetType)
  return _s;
}
inline const std::string& CTxUtxos::_internal_assettype() const {
  return _impl_.assettype_.Get();
}
inline void CTxUtxos::_internal_set_assettype(const std::string& value) {
  
  _impl_.assettype_.Set(value, GetArenaForAllocation());
}
inline std::string* CTxUtxos::_internal_mutable_assettype() {
  
  return _impl_.assettype_.Mutable(GetArenaForAllocation());
}
inline std::string* CTxUtxos::release_assettype() {
  // @@protoc_insertion_point(field_release:CTxUtxos.assetType)
  return _impl_.assettype_.Release();
}
inline void CTxUtxos::set_allocated_assettype(std::string* assettype) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:CTxUtxos.assetType)
}

// int64 GasUtxo = 6;
inline void CTxUtxos::clear_gasutxo() {
  _impl_.gasutxo_ = int64_t{0};
}
inline int64_t CTxUtxos::_internal_gasutxo() const {
  return _impl_.gasutxo_;
}
inline int64_t CTxUtxos::gasutxo() const {
  // @@protoc_insertion_point(field_get:CTxUtxos.GasUtxo)
  return _internal_gasutxo();
}
inline void CTxUtxos::_internal_set_gasutxo(int64_t value) {
  
  _impl_.gasutxo_ = value;
}
inline void CTxUtxos::set_gasutxo(int64_t value) {
  _internal_set_gasutxo(value);
  // @@protoc_insertion_point(field_set:CTxUtxos.GasUtxo)
}
...
// repeated .CTxUtxos utxos = 14;
inline int CTransaction::_internal_utxos_size() const {
  return _impl_.utxos_.size();
}
inline int CTransaction::utxos_size() const {
  return _internal_utxos_size();
}
inline void CTransaction::clear_utxos() {
  _impl_.utxos_.Clear();
}
inline ::CTxUtxos* CTransaction::mutable_utxos(int index) {
  // @@protoc_insertion_point(field_mutable:CTransaction.utxos)
  return _impl_.utxos_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxUtxos >*
CTransaction::mutable_utxos() {
  // @@protoc_insertion_point(field_mutable_list:CTransaction.utxos)
  return &_impl_.utxos_;
}
inline const ::CTxUtxos& CTransaction::_internal_utxos(int index) const {
  return _impl_.utxos_.Get(index);
}
inline const ::CTxUtxos& CTransaction::utxos(int index) const {
  // @@protoc_insertion_point(field_get:CTransaction.utxos)
  return _internal_utxos(index);
}
inline ::CTxUtxos* CTransaction::_internal_add_utxos() {
  return _impl_.utxos_.Add();
}
inline ::CTxUtxos* CTransaction::add_utxos() {
  ::CTxUtxos* _add = _internal_add_utxos();
  // @@protoc_insertion_point(field_add:CTransaction.utxos)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CTxUtxos >&
CTransaction::utxos() const {
  // @@protoc_insertion_point(field_list:CTransaction.utxos)
  return _impl_.utxos_;
}

// uint32 gasTx = 15;
inline void CTransaction::clear_gastx() {
  _impl_.gastx_ = 0u;
}
inline uint32_t CTransaction::_internal_gastx() const {
  return _impl_.gastx_;
}
inline uint32_t CTransaction::gastx() const {
  // @@protoc_insertion_point(field_get:CTransaction.gasTx)
  return _internal_gastx();
}
inline void CTransaction::_internal_set_gastx(uint32_t value) {
  
  _impl_.gastx_ = value;
}
inline void CTransaction::set_gastx(uint32_t value) {
  _internal_set_gastx(value);
  // @@protoc_insertion_point(field_set:CTransaction.gasTx)
}
