...
class SDKBonusamout final :
 ...
 public:
  ...
  enum : int {
    kAddressFieldNumber = 1,
    kDelegatingAmountFieldNumber = 2,
  };
  // string address = 1;
  void clear_address();
  const std::string& address() const;
  ...
  // uint64 delegating_amount = 2;
  void clear_delegating_amount();
  uint64_t delegating_amount() const;
  void set_delegating_amount(uint64_t value);
  private:
  uint64_t _internal_delegating_amount() const;
  void _internal_set_delegating_amount(uint64_t value);
  public:
...
class GetSDKAck final :
 ...
 public:
  ...
  enum : int {
    ...
    kDelegatingedAddrFieldNumber = 13,
    kBonusTxFieldNumber = 14,
    kBonusAddrDelegateUtxosFieldNumber = 15,
    kClaimtxFieldNumber = 16,
    kAbnormaladdrCntFieldNumber = 17,
    kNodeinfoFieldNumber = 22,
    kClaimBonusTxFieldNumber = 24,
    kClaimDelegatingedAddrFieldNumber = 26,
    kClaimBonusAddrDelegateUtxosFieldNumber = 27,
    kVersionFieldNumber = 1,
    kMessageFieldNumber = 3,
    kHeightFieldNumber = 4,
    kM2FieldNumber = 18,
    kTotaldelegatingFieldNumber = 19,
  ...
  // repeated string DelegatingedAddr = 13;
  int delegatingedaddr_size() const;
  private:
  int _internal_delegatingedaddr_size() const;
  public:
  void clear_delegatingedaddr();
  const std::string& delegatingedaddr(int index) const;
  std::string* mutable_delegatingedaddr(int index);
  void set_delegatingedaddr(int index, const std::string& value);
  void set_delegatingedaddr(int index, std::string&& value);
  void set_delegatingedaddr(int index, const char* value);
  void set_delegatingedaddr(int index, const char* value, size_t size);
  std::string* add_delegatingedaddr();
  void add_delegatingedaddr(const std::string& value);
  void add_delegatingedaddr(std::string&& value);
  void add_delegatingedaddr(const char* value);
  void add_delegatingedaddr(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& delegatingedaddr() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_delegatingedaddr();
  private:
  const std::string& _internal_delegatingedaddr(int index) const;
  std::string* _internal_add_delegatingedaddr();
  public:
  ...
  // repeated string BonusAddrDelegateUtxos = 15;
  int bonusaddrdelegateutxos_size() const;
  private:
  int _internal_bonusaddrdelegateutxos_size() const;
  public:
  void clear_bonusaddrdelegateutxos();
  const std::string& bonusaddrdelegateutxos(int index) const;
  std::string* mutable_bonusaddrdelegateutxos(int index);
  void set_bonusaddrdelegateutxos(int index, const std::string& value);
  void set_bonusaddrdelegateutxos(int index, std::string&& value);
  void set_bonusaddrdelegateutxos(int index, const char* value);
  void set_bonusaddrdelegateutxos(int index, const char* value, size_t size);
  std::string* add_bonusaddrdelegateutxos();
  void add_bonusaddrdelegateutxos(const std::string& value);
  void add_bonusaddrdelegateutxos(std::string&& value);
  void add_bonusaddrdelegateutxos(const char* value);
  void add_bonusaddrdelegateutxos(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& bonusaddrdelegateutxos() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_bonusaddrdelegateutxos();
  private:
  const std::string& _internal_bonusaddrdelegateutxos(int index) const;
  std::string* _internal_add_bonusaddrdelegateutxos();
  public:
  ...
  // repeated string ClaimDelegatingedAddr = 26;
  int claimdelegatingedaddr_size() const;
  private:
  int _internal_claimdelegatingedaddr_size() const;
  public:
  void clear_claimdelegatingedaddr();
  const std::string& claimdelegatingedaddr(int index) const;
  std::string* mutable_claimdelegatingedaddr(int index);
  void set_claimdelegatingedaddr(int index, const std::string& value);
  void set_claimdelegatingedaddr(int index, std::string&& value);
  void set_claimdelegatingedaddr(int index, const char* value);
  void set_claimdelegatingedaddr(int index, const char* value, size_t size);
  std::string* add_claimdelegatingedaddr();
  void add_claimdelegatingedaddr(const std::string& value);
  void add_claimdelegatingedaddr(std::string&& value);
  void add_claimdelegatingedaddr(const char* value);
  void add_claimdelegatingedaddr(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& claimdelegatingedaddr() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_claimdelegatingedaddr();
  private:
  const std::string& _internal_claimdelegatingedaddr(int index) const;
  std::string* _internal_add_claimdelegatingedaddr();
  public:

  // repeated string ClaimBonusAddrDelegateUtxos = 27;
  int claimbonusaddrdelegateutxos_size() const;
  private:
  int _internal_claimbonusaddrdelegateutxos_size() const;
  public:
  void clear_claimbonusaddrdelegateutxos();
  const std::string& claimbonusaddrdelegateutxos(int index) const;
  std::string* mutable_claimbonusaddrdelegateutxos(int index);
  void set_claimbonusaddrdelegateutxos(int index, const std::string& value);
  void set_claimbonusaddrdelegateutxos(int index, std::string&& value);
  void set_claimbonusaddrdelegateutxos(int index, const char* value);
  void set_claimbonusaddrdelegateutxos(int index, const char* value, size_t size);
  std::string* add_claimbonusaddrdelegateutxos();
  void add_claimbonusaddrdelegateutxos(const std::string& value);
  void add_claimbonusaddrdelegateutxos(std::string&& value);
  void add_claimbonusaddrdelegateutxos(const char* value);
  void add_claimbonusaddrdelegateutxos(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& claimbonusaddrdelegateutxos() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_claimbonusaddrdelegateutxos();
  private:
  const std::string& _internal_claimbonusaddrdelegateutxos(int index) const;
  std::string* _internal_add_claimbonusaddrdelegateutxos();
  public:
  ...
  // uint64 Totaldelegating = 19;
  void clear_totaldelegating();
  uint64_t totaldelegating() const;
  void set_totaldelegating(uint64_t value);
  private:
  uint64_t _internal_totaldelegating() const;
  void _internal_set_totaldelegating(uint64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> delegatingedaddr_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::SDKBonusTx > bonustx_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> bonusaddrdelegateutxos_;
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> claimdelegatingedaddr_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> claimbonusaddrdelegateutxos_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr version_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr message_;
    uint64_t height_;
    uint64_t m2_;
    uint64_t totaldelegating_;
...
// uint64 delegating_amount = 2;
inline void SDKBonusamout::clear_delegating_amount() {
  _impl_.delegating_amount_ = uint64_t{0u};
}
inline uint64_t SDKBonusamout::_internal_delegating_amount() const {
  return _impl_.delegating_amount_;
}
inline uint64_t SDKBonusamout::delegating_amount() const {
  // @@protoc_insertion_point(field_get:SDKBonusamout.delegating_amount)
  return _internal_delegating_amount();
}
inline void SDKBonusamout::_internal_set_delegating_amount(uint64_t value) {
  
  _impl_.delegating_amount_ = value;
}
inline void SDKBonusamout::set_delegating_amount(uint64_t value) {
  _internal_set_delegating_amount(value);
  // @@protoc_insertion_point(field_set:SDKBonusamout.delegating_amount)
}
...
// repeated string DelegatingedAddr = 13;
inline int GetSDKAck::_internal_delegatingedaddr_size() const {
  return _impl_.delegatingedaddr_.size();
}
inline int GetSDKAck::delegatingedaddr_size() const {
  return _internal_delegatingedaddr_size();
}
inline void GetSDKAck::clear_delegatingedaddr() {
  _impl_.delegatingedaddr_.Clear();
}
inline std::string* GetSDKAck::add_delegatingedaddr() {
  std::string* _s = _internal_add_delegatingedaddr();
  // @@protoc_insertion_point(field_add_mutable:GetSDKAck.DelegatingedAddr)
  return _s;
}
inline const std::string& GetSDKAck::_internal_delegatingedaddr(int index) const {
  return _impl_.delegatingedaddr_.Get(index);
}
inline const std::string& GetSDKAck::delegatingedaddr(int index) const {
  // @@protoc_insertion_point(field_get:GetSDKAck.DelegatingedAddr)
  return _internal_delegatingedaddr(index);
}
inline std::string* GetSDKAck::mutable_delegatingedaddr(int index) {
  // @@protoc_insertion_point(field_mutable:GetSDKAck.DelegatingedAddr)
  return _impl_.delegatingedaddr_.Mutable(index);
}
inline void GetSDKAck::set_delegatingedaddr(int index, const std::string& value) {
  _impl_.delegatingedaddr_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:GetSDKAck.DelegatingedAddr)
}
inline void GetSDKAck::set_delegatingedaddr(int index, std::string&& value) {
  _impl_.delegatingedaddr_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:GetSDKAck.DelegatingedAddr)
}
inline void GetSDKAck::set_delegatingedaddr(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.delegatingedaddr_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:GetSDKAck.DelegatingedAddr)
}
inline void GetSDKAck::set_delegatingedaddr(int index, const char* value, size_t size) {
  _impl_.delegatingedaddr_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:GetSDKAck.DelegatingedAddr)
}
inline std::string* GetSDKAck::_internal_add_delegatingedaddr() {
  return _impl_.delegatingedaddr_.Add();
}
inline void GetSDKAck::add_delegatingedaddr(const std::string& value) {
  _impl_.delegatingedaddr_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:GetSDKAck.DelegatingedAddr)
}
inline void GetSDKAck::add_delegatingedaddr(std::string&& value) {
  _impl_.delegatingedaddr_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:GetSDKAck.DelegatingedAddr)
}
inline void GetSDKAck::add_delegatingedaddr(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.delegatingedaddr_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:GetSDKAck.DelegatingedAddr)
}
inline void GetSDKAck::add_delegatingedaddr(const char* value, size_t size) {
  _impl_.delegatingedaddr_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:GetSDKAck.DelegatingedAddr)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetSDKAck::delegatingedaddr() const {
  // @@protoc_insertion_point(field_list:GetSDKAck.DelegatingedAddr)
  return _impl_.delegatingedaddr_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetSDKAck::mutable_delegatingedaddr() {
  // @@protoc_insertion_point(field_mutable_list:GetSDKAck.DelegatingedAddr)
  return &_impl_.delegatingedaddr_;
}
...
// repeated string BonusAddrDelegateUtxos = 15;
inline int GetSDKAck::_internal_bonusaddrdelegateutxos_size() const {
  return _impl_.bonusaddrdelegateutxos_.size();
}
inline int GetSDKAck::bonusaddrdelegateutxos_size() const {
  return _internal_bonusaddrdelegateutxos_size();
}
inline void GetSDKAck::clear_bonusaddrdelegateutxos() {
  _impl_.bonusaddrdelegateutxos_.Clear();
}
inline std::string* GetSDKAck::add_bonusaddrdelegateutxos() {
  std::string* _s = _internal_add_bonusaddrdelegateutxos();
  // @@protoc_insertion_point(field_add_mutable:GetSDKAck.BonusAddrDelegateUtxos)
  return _s;
}
inline const std::string& GetSDKAck::_internal_bonusaddrdelegateutxos(int index) const {
  return _impl_.bonusaddrdelegateutxos_.Get(index);
}
inline const std::string& GetSDKAck::bonusaddrdelegateutxos(int index) const {
  // @@protoc_insertion_point(field_get:GetSDKAck.BonusAddrDelegateUtxos)
  return _internal_bonusaddrdelegateutxos(index);
}
inline std::string* GetSDKAck::mutable_bonusaddrdelegateutxos(int index) {
  // @@protoc_insertion_point(field_mutable:GetSDKAck.BonusAddrDelegateUtxos)
  return _impl_.bonusaddrdelegateutxos_.Mutable(index);
}
inline void GetSDKAck::set_bonusaddrdelegateutxos(int index, const std::string& value) {
  _impl_.bonusaddrdelegateutxos_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:GetSDKAck.BonusAddrDelegateUtxos)
}
inline void GetSDKAck::set_bonusaddrdelegateutxos(int index, std::string&& value) {
  _impl_.bonusaddrdelegateutxos_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:GetSDKAck.BonusAddrDelegateUtxos)
}
inline void GetSDKAck::set_bonusaddrdelegateutxos(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.bonusaddrdelegateutxos_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:GetSDKAck.BonusAddrDelegateUtxos)
}
inline void GetSDKAck::set_bonusaddrdelegateutxos(int index, const char* value, size_t size) {
  _impl_.bonusaddrdelegateutxos_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:GetSDKAck.BonusAddrDelegateUtxos)
}
inline std::string* GetSDKAck::_internal_add_bonusaddrdelegateutxos() {
  return _impl_.bonusaddrdelegateutxos_.Add();
}
inline void GetSDKAck::add_bonusaddrdelegateutxos(const std::string& value) {
  _impl_.bonusaddrdelegateutxos_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:GetSDKAck.BonusAddrDelegateUtxos)
}
inline void GetSDKAck::add_bonusaddrdelegateutxos(std::string&& value) {
  _impl_.bonusaddrdelegateutxos_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:GetSDKAck.BonusAddrDelegateUtxos)
}
inline void GetSDKAck::add_bonusaddrdelegateutxos(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.bonusaddrdelegateutxos_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:GetSDKAck.BonusAddrDelegateUtxos)
}
inline void GetSDKAck::add_bonusaddrdelegateutxos(const char* value, size_t size) {
  _impl_.bonusaddrdelegateutxos_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:GetSDKAck.BonusAddrDelegateUtxos)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetSDKAck::bonusaddrdelegateutxos() const {
  // @@protoc_insertion_point(field_list:GetSDKAck.BonusAddrDelegateUtxos)
  return _impl_.bonusaddrdelegateutxos_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetSDKAck::mutable_bonusaddrdelegateutxos() {
  // @@protoc_insertion_point(field_mutable_list:GetSDKAck.BonusAddrDelegateUtxos)
  return &_impl_.bonusaddrdelegateutxos_;
}
...
// uint64 Totaldelegating = 19;
inline void GetSDKAck::clear_totaldelegating() {
  _impl_.totaldelegating_ = uint64_t{0u};
}
inline uint64_t GetSDKAck::_internal_totaldelegating() const {
  return _impl_.totaldelegating_;
}
inline uint64_t GetSDKAck::totaldelegating() const {
  // @@protoc_insertion_point(field_get:GetSDKAck.Totaldelegating)
  return _internal_totaldelegating();
}
inline void GetSDKAck::_internal_set_totaldelegating(uint64_t value) {
  
  _impl_.totaldelegating_ = value;
}
inline void GetSDKAck::set_totaldelegating(uint64_t value) {
  _internal_set_totaldelegating(value);
  // @@protoc_insertion_point(field_set:GetSDKAck.Totaldelegating)
}
...
// repeated string ClaimDelegatingedAddr = 26;
inline int GetSDKAck::_internal_claimdelegatingedaddr_size() const {
  return _impl_.claimdelegatingedaddr_.size();
}
inline int GetSDKAck::claimdelegatingedaddr_size() const {
  return _internal_claimdelegatingedaddr_size();
}
inline void GetSDKAck::clear_claimdelegatingedaddr() {
  _impl_.claimdelegatingedaddr_.Clear();
}
inline std::string* GetSDKAck::add_claimdelegatingedaddr() {
  std::string* _s = _internal_add_claimdelegatingedaddr();
  // @@protoc_insertion_point(field_add_mutable:GetSDKAck.ClaimDelegatingedAddr)
  return _s;
}
inline const std::string& GetSDKAck::_internal_claimdelegatingedaddr(int index) const {
  return _impl_.claimdelegatingedaddr_.Get(index);
}
inline const std::string& GetSDKAck::claimdelegatingedaddr(int index) const {
  // @@protoc_insertion_point(field_get:GetSDKAck.ClaimDelegatingedAddr)
  return _internal_claimdelegatingedaddr(index);
}
inline std::string* GetSDKAck::mutable_claimdelegatingedaddr(int index) {
  // @@protoc_insertion_point(field_mutable:GetSDKAck.ClaimDelegatingedAddr)
  return _impl_.claimdelegatingedaddr_.Mutable(index);
}
inline void GetSDKAck::set_claimdelegatingedaddr(int index, const std::string& value) {
  _impl_.claimdelegatingedaddr_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:GetSDKAck.ClaimDelegatingedAddr)
}
inline void GetSDKAck::set_claimdelegatingedaddr(int index, std::string&& value) {
  _impl_.claimdelegatingedaddr_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:GetSDKAck.ClaimDelegatingedAddr)
}
inline void GetSDKAck::set_claimdelegatingedaddr(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.claimdelegatingedaddr_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:GetSDKAck.ClaimDelegatingedAddr)
}
inline void GetSDKAck::set_claimdelegatingedaddr(int index, const char* value, size_t size) {
  _impl_.claimdelegatingedaddr_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:GetSDKAck.ClaimDelegatingedAddr)
}
inline std::string* GetSDKAck::_internal_add_claimdelegatingedaddr() {
  return _impl_.claimdelegatingedaddr_.Add();
}
inline void GetSDKAck::add_claimdelegatingedaddr(const std::string& value) {
  _impl_.claimdelegatingedaddr_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:GetSDKAck.ClaimDelegatingedAddr)
}
inline void GetSDKAck::add_claimdelegatingedaddr(std::string&& value) {
  _impl_.claimdelegatingedaddr_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:GetSDKAck.ClaimDelegatingedAddr)
}
inline void GetSDKAck::add_claimdelegatingedaddr(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.claimdelegatingedaddr_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:GetSDKAck.ClaimDelegatingedAddr)
}
inline void GetSDKAck::add_claimdelegatingedaddr(const char* value, size_t size) {
  _impl_.claimdelegatingedaddr_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:GetSDKAck.ClaimDelegatingedAddr)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetSDKAck::claimdelegatingedaddr() const {
  // @@protoc_insertion_point(field_list:GetSDKAck.ClaimDelegatingedAddr)
  return _impl_.claimdelegatingedaddr_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetSDKAck::mutable_claimdelegatingedaddr() {
  // @@protoc_insertion_point(field_mutable_list:GetSDKAck.ClaimDelegatingedAddr)
  return &_impl_.claimdelegatingedaddr_;
}

// repeated string ClaimBonusAddrDelegateUtxos = 27;
inline int GetSDKAck::_internal_claimbonusaddrdelegateutxos_size() const {
  return _impl_.claimbonusaddrdelegateutxos_.size();
}
inline int GetSDKAck::claimbonusaddrdelegateutxos_size() const {
  return _internal_claimbonusaddrdelegateutxos_size();
}
inline void GetSDKAck::clear_claimbonusaddrdelegateutxos() {
  _impl_.claimbonusaddrdelegateutxos_.Clear();
}
inline std::string* GetSDKAck::add_claimbonusaddrdelegateutxos() {
  std::string* _s = _internal_add_claimbonusaddrdelegateutxos();
  // @@protoc_insertion_point(field_add_mutable:GetSDKAck.ClaimBonusAddrDelegateUtxos)
  return _s;
}
inline const std::string& GetSDKAck::_internal_claimbonusaddrdelegateutxos(int index) const {
  return _impl_.claimbonusaddrdelegateutxos_.Get(index);
}
inline const std::string& GetSDKAck::claimbonusaddrdelegateutxos(int index) const {
  // @@protoc_insertion_point(field_get:GetSDKAck.ClaimBonusAddrDelegateUtxos)
  return _internal_claimbonusaddrdelegateutxos(index);
}
inline std::string* GetSDKAck::mutable_claimbonusaddrdelegateutxos(int index) {
  // @@protoc_insertion_point(field_mutable:GetSDKAck.ClaimBonusAddrDelegateUtxos)
  return _impl_.claimbonusaddrdelegateutxos_.Mutable(index);
}
inline void GetSDKAck::set_claimbonusaddrdelegateutxos(int index, const std::string& value) {
  _impl_.claimbonusaddrdelegateutxos_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline void GetSDKAck::set_claimbonusaddrdelegateutxos(int index, std::string&& value) {
  _impl_.claimbonusaddrdelegateutxos_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline void GetSDKAck::set_claimbonusaddrdelegateutxos(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.claimbonusaddrdelegateutxos_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline void GetSDKAck::set_claimbonusaddrdelegateutxos(int index, const char* value, size_t size) {
  _impl_.claimbonusaddrdelegateutxos_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline std::string* GetSDKAck::_internal_add_claimbonusaddrdelegateutxos() {
  return _impl_.claimbonusaddrdelegateutxos_.Add();
}
inline void GetSDKAck::add_claimbonusaddrdelegateutxos(const std::string& value) {
  _impl_.claimbonusaddrdelegateutxos_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline void GetSDKAck::add_claimbonusaddrdelegateutxos(std::string&& value) {
  _impl_.claimbonusaddrdelegateutxos_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline void GetSDKAck::add_claimbonusaddrdelegateutxos(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.claimbonusaddrdelegateutxos_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline void GetSDKAck::add_claimbonusaddrdelegateutxos(const char* value, size_t size) {
  _impl_.claimbonusaddrdelegateutxos_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:GetSDKAck.ClaimBonusAddrDelegateUtxos)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetSDKAck::claimbonusaddrdelegateutxos() const {
  // @@protoc_insertion_point(field_list:GetSDKAck.ClaimBonusAddrDelegateUtxos)
  return _impl_.claimbonusaddrdelegateutxos_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetSDKAck::mutable_claimbonusaddrdelegateutxos() {
  // @@protoc_insertion_point(field_mutable_list:GetSDKAck.ClaimBonusAddrDelegateUtxos)
  return &_impl_.claimbonusaddrdelegateutxos_;
}
