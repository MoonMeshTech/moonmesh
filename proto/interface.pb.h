...
class DelegateAddressItem;
struct DelegateAddressItemDefaultTypeInternal;
extern DelegateAddressItemDefaultTypeInternal _DelegateAddressItem_default_instance_;
class DelegateItem;
struct DelegateItemDefaultTypeInternal;
extern DelegateItemDefaultTypeInternal _DelegateItem_default_instance_;
class GetAllDelegateAddressAck;
struct GetAllDelegateAddressAckDefaultTypeInternal;
extern GetAllDelegateAddressAckDefaultTypeInternal _GetAllDelegateAddressAck_default_instance_;
class GetAllDelegateAddressReq;
struct GetAllDelegateAddressReqDefaultTypeInternal;
extern GetAllDelegateAddressReqDefaultTypeInternal _GetAllDelegateAddressReq_default_instance_;
...
class GetDelegateListAck;
struct GetDelegateListAckDefaultTypeInternal;
extern GetDelegateListAckDefaultTypeInternal _GetDelegateListAck_default_instance_;
class GetDelegateListReq;
struct GetDelegateListReqDefaultTypeInternal;
extern GetDelegateListReqDefaultTypeInternal _GetDelegateListReq_default_instance_;
class GetHeightAck;
...
class GetRestDelegateAmountAck;
struct GetRestDelegateAmountAckDefaultTypeInternal;
extern GetRestDelegateAmountAckDefaultTypeInternal _GetRestDelegateAmountAck_default_instance_;
class GetRestDelegateAmountReq;
struct GetRestDelegateAmountReqDefaultTypeInternal;
extern GetRestDelegateAmountReqDefaultTypeInternal _GetRestDelegateAmountReq_default_instance_;
...
template<> ::DelegateAddressItem* Arena::CreateMaybeMessage<::DelegateAddressItem>(Arena*);
template<> ::DelegateItem* Arena::CreateMaybeMessage<::DelegateItem>(Arena*);
template<> ::GetAllDelegateAddressAck* Arena::CreateMaybeMessage<::GetAllDelegateAddressAck>(Arena*);
template<> ::GetAllDelegateAddressReq* Arena::CreateMaybeMessage<::GetAllDelegateAddressReq>(Arena*);
...
template<> ::GetDelegateListAck* Arena::CreateMaybeMessage<::GetDelegateListAck>(Arena*);
template<> ::GetDelegateListReq* Arena::CreateMaybeMessage<::GetDelegateListReq>(Arena*);
...
template<> ::GetRestDelegateAmountAck* Arena::CreateMaybeMessage<::GetRestDelegateAmountAck>(Arena*);
template<> ::GetRestDelegateAmountReq* Arena::CreateMaybeMessage<::GetRestDelegateAmountReq>(Arena*);
...
class GetDelegateListReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GetDelegateListReq) */ {
 public:
  inline GetDelegateListReq() : GetDelegateListReq(nullptr) {}
  ~GetDelegateListReq() override;
  explicit PROTOBUF_CONSTEXPR GetDelegateListReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetDelegateListReq(const GetDelegateListReq& from);
  GetDelegateListReq(GetDelegateListReq&& from) noexcept
    : GetDelegateListReq() {
    *this = ::std::move(from);
  }

  inline GetDelegateListReq& operator=(const GetDelegateListReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetDelegateListReq& operator=(GetDelegateListReq&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetDelegateListReq& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetDelegateListReq* internal_default_instance() {
    return reinterpret_cast<const GetDelegateListReq*>(
               &_GetDelegateListReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(GetDelegateListReq& a, GetDelegateListReq& b) {
    a.Swap(&b);
  }
  inline void Swap(GetDelegateListReq* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetDelegateListReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetDelegateListReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetDelegateListReq>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetDelegateListReq& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetDelegateListReq& from) {
    GetDelegateListReq::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetDelegateListReq* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GetDelegateListReq";
  }
  protected:
  explicit GetDelegateListReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:GetDelegateListReq)
 private:
  class _Internal;
...
class DelegateItem final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:DelegateItem) */ {
 public:
  inline DelegateItem() : DelegateItem(nullptr) {}
  ~DelegateItem() override;
  explicit PROTOBUF_CONSTEXPR DelegateItem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DelegateItem(const DelegateItem& from);
  DelegateItem(DelegateItem&& from) noexcept
    : DelegateItem() {
    *this = ::std::move(from);
  }

  inline DelegateItem& operator=(const DelegateItem& from) {
    CopyFrom(from);
    return *this;
  }
  inline DelegateItem& operator=(DelegateItem&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const DelegateItem& default_instance() {
    return *internal_default_instance();
  }
  static inline const DelegateItem* internal_default_instance() {
    return reinterpret_cast<const DelegateItem*>(
               &_DelegateItem_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(DelegateItem& a, DelegateItem& b) {
    a.Swap(&b);
  }
  inline void Swap(DelegateItem* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(DelegateItem* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DelegateItem* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DelegateItem>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const DelegateItem& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const DelegateItem& from) {
    DelegateItem::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DelegateItem* other);
  ...
  protected:
  explicit DelegateItem(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:DelegateItem)
 private:
  class _Internal;
...
class GetDelegateListAck final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GetDelegateListAck) */ {
 public:
  inline GetDelegateListAck() : GetDelegateListAck(nullptr) {}
  ~GetDelegateListAck() override;
  explicit PROTOBUF_CONSTEXPR GetDelegateListAck(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetDelegateListAck(const GetDelegateListAck& from);
  GetDelegateListAck(GetDelegateListAck&& from) noexcept
    : GetDelegateListAck() {
    *this = ::std::move(from);
  }

  inline GetDelegateListAck& operator=(const GetDelegateListAck& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetDelegateListAck& operator=(GetDelegateListAck&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetDelegateListAck& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetDelegateListAck* internal_default_instance() {
    return reinterpret_cast<const GetDelegateListAck*>(
               &_GetDelegateListAck_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(GetDelegateListAck& a, GetDelegateListAck& b) {
    a.Swap(&b);
  }
  inline void Swap(GetDelegateListAck* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetDelegateListAck* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetDelegateListAck* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetDelegateListAck>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetDelegateListAck& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetDelegateListAck& from) {
    GetDelegateListAck::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetDelegateListAck* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GetDelegateListAck";
  }
  protected:
  explicit GetDelegateListAck(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // repeated .DelegateItem list = 4;
  int list_size() const;
  private:
  int _internal_list_size() const;
  public:
  void clear_list();
  ::DelegateItem* mutable_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateItem >*
      mutable_list();
  private:
  const ::DelegateItem& _internal_list(int index) const;
  ::DelegateItem* _internal_add_list();
  public:
  const ::DelegateItem& list(int index) const;
  ::DelegateItem* add_list();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateItem >&
      list() const;
  ...
  // @@protoc_insertion_point(class_scope:GetDelegateListAck)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateItem > list_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr version_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr message_;
    int32_t code_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
class GetAllDelegateAddressReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GetAllDelegateAddressReq) */ {
 public:
  inline GetAllDelegateAddressReq() : GetAllDelegateAddressReq(nullptr) {}
  ~GetAllDelegateAddressReq() override;
  explicit PROTOBUF_CONSTEXPR GetAllDelegateAddressReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetAllDelegateAddressReq(const GetAllDelegateAddressReq& from);
  GetAllDelegateAddressReq(GetAllDelegateAddressReq&& from) noexcept
    : GetAllDelegateAddressReq() {
    *this = ::std::move(from);
  }

  inline GetAllDelegateAddressReq& operator=(const GetAllDelegateAddressReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetAllDelegateAddressReq& operator=(GetAllDelegateAddressReq&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetAllDelegateAddressReq& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetAllDelegateAddressReq* internal_default_instance() {
    return reinterpret_cast<const GetAllDelegateAddressReq*>(
               &_GetAllDelegateAddressReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    22;

  friend void swap(GetAllDelegateAddressReq& a, GetAllDelegateAddressReq& b) {
    a.Swap(&b);
  }
  inline void Swap(GetAllDelegateAddressReq* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetAllDelegateAddressReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetAllDelegateAddressReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetAllDelegateAddressReq>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetAllDelegateAddressReq& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetAllDelegateAddressReq& from) {
    GetAllDelegateAddressReq::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetAllDelegateAddressReq* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GetAllDelegateAddressReq";
  }
  protected:
  explicit GetAllDelegateAddressReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:GetAllDelegateAddressReq)
 private:
  class _Internal;
...
class DelegateAddressItem final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:DelegateAddressItem) */ {
 public:
  inline DelegateAddressItem() : DelegateAddressItem(nullptr) {}
  ~DelegateAddressItem() override;
  explicit PROTOBUF_CONSTEXPR DelegateAddressItem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DelegateAddressItem(const DelegateAddressItem& from);
  DelegateAddressItem(DelegateAddressItem&& from) noexcept
    : DelegateAddressItem() {
    *this = ::std::move(from);
  }

  inline DelegateAddressItem& operator=(const DelegateAddressItem& from) {
    CopyFrom(from);
    return *this;
  }
  inline DelegateAddressItem& operator=(DelegateAddressItem&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const DelegateAddressItem& default_instance() {
    return *internal_default_instance();
  }
  static inline const DelegateAddressItem* internal_default_instance() {
    return reinterpret_cast<const DelegateAddressItem*>(
               &_DelegateAddressItem_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    23;

  friend void swap(DelegateAddressItem& a, DelegateAddressItem& b) {
    a.Swap(&b);
  }
  inline void Swap(DelegateAddressItem* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(DelegateAddressItem* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DelegateAddressItem* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DelegateAddressItem>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const DelegateAddressItem& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const DelegateAddressItem& from) {
    DelegateAddressItem::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DelegateAddressItem* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "DelegateAddressItem";
  }
  protected:
  explicit DelegateAddressItem(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:DelegateAddressItem)
 private:
  class _Internal;
...
class GetAllDelegateAddressAck final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GetAllDelegateAddressAck) */ {
 public:
  inline GetAllDelegateAddressAck() : GetAllDelegateAddressAck(nullptr) {}
  ~GetAllDelegateAddressAck() override;
  explicit PROTOBUF_CONSTEXPR GetAllDelegateAddressAck(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetAllDelegateAddressAck(const GetAllDelegateAddressAck& from);
  GetAllDelegateAddressAck(GetAllDelegateAddressAck&& from) noexcept
    : GetAllDelegateAddressAck() {
    *this = ::std::move(from);
  }

  inline GetAllDelegateAddressAck& operator=(const GetAllDelegateAddressAck& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetAllDelegateAddressAck& operator=(GetAllDelegateAddressAck&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetAllDelegateAddressAck& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetAllDelegateAddressAck* internal_default_instance() {
    return reinterpret_cast<const GetAllDelegateAddressAck*>(
               &_GetAllDelegateAddressAck_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    24;

  friend void swap(GetAllDelegateAddressAck& a, GetAllDelegateAddressAck& b) {
    a.Swap(&b);
  }
  inline void Swap(GetAllDelegateAddressAck* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetAllDelegateAddressAck* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetAllDelegateAddressAck* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetAllDelegateAddressAck>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetAllDelegateAddressAck& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetAllDelegateAddressAck& from) {
    GetAllDelegateAddressAck::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetAllDelegateAddressAck* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GetAllDelegateAddressAck";
  }
  protected:
  explicit GetAllDelegateAddressAck(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // repeated .DelegateAddressItem list = 5;
  int list_size() const;
  private:
  int _internal_list_size() const;
  public:
  void clear_list();
  ::DelegateAddressItem* mutable_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateAddressItem >*
      mutable_list();
  private:
  const ::DelegateAddressItem& _internal_list(int index) const;
  ::DelegateAddressItem* _internal_add_list();
  public:
  const ::DelegateAddressItem& list(int index) const;
  ::DelegateAddressItem* add_list();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateAddressItem >&
      list() const;
  ...
  // @@protoc_insertion_point(class_scope:GetAllDelegateAddressAck)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateAddressItem > list_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr version_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr message_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr addr_;
    int32_t code_;
...
class GetRestDelegateAmountReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GetRestDelegateAmountReq) */ {
 public:
  inline GetRestDelegateAmountReq() : GetRestDelegateAmountReq(nullptr) {}
  ~GetRestDelegateAmountReq() override;
  explicit PROTOBUF_CONSTEXPR GetRestDelegateAmountReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetRestDelegateAmountReq(const GetRestDelegateAmountReq& from);
  GetRestDelegateAmountReq(GetRestDelegateAmountReq&& from) noexcept
    : GetRestDelegateAmountReq() {
    *this = ::std::move(from);
  }

  inline GetRestDelegateAmountReq& operator=(const GetRestDelegateAmountReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetRestDelegateAmountReq& operator=(GetRestDelegateAmountReq&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetRestDelegateAmountReq& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetRestDelegateAmountReq* internal_default_instance() {
    return reinterpret_cast<const GetRestDelegateAmountReq*>(
               &_GetRestDelegateAmountReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    51;

  friend void swap(GetRestDelegateAmountReq& a, GetRestDelegateAmountReq& b) {
    a.Swap(&b);
  }
  inline void Swap(GetRestDelegateAmountReq* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetRestDelegateAmountReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetRestDelegateAmountReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetRestDelegateAmountReq>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetRestDelegateAmountReq& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetRestDelegateAmountReq& from) {
    GetRestDelegateAmountReq::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetRestDelegateAmountReq* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GetRestDelegateAmountReq";
  }
  protected:
  explicit GetRestDelegateAmountReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:GetRestDelegateAmountReq)
 private:
  class _Internal;
...
class GetRestDelegateAmountAck final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GetRestDelegateAmountAck) */ {
 public:
  inline GetRestDelegateAmountAck() : GetRestDelegateAmountAck(nullptr) {}
  ~GetRestDelegateAmountAck() override;
  explicit PROTOBUF_CONSTEXPR GetRestDelegateAmountAck(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetRestDelegateAmountAck(const GetRestDelegateAmountAck& from);
  GetRestDelegateAmountAck(GetRestDelegateAmountAck&& from) noexcept
    : GetRestDelegateAmountAck() {
    *this = ::std::move(from);
  }

  inline GetRestDelegateAmountAck& operator=(const GetRestDelegateAmountAck& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetRestDelegateAmountAck& operator=(GetRestDelegateAmountAck&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetRestDelegateAmountAck& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetRestDelegateAmountAck* internal_default_instance() {
    return reinterpret_cast<const GetRestDelegateAmountAck*>(
               &_GetRestDelegateAmountAck_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    52;

  friend void swap(GetRestDelegateAmountAck& a, GetRestDelegateAmountAck& b) {
    a.Swap(&b);
  }
  inline void Swap(GetRestDelegateAmountAck* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetRestDelegateAmountAck* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetRestDelegateAmountAck* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetRestDelegateAmountAck>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetRestDelegateAmountAck& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetRestDelegateAmountAck& from) {
    GetRestDelegateAmountAck::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetRestDelegateAmountAck* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "GetRestDelegateAmountAck";
  }
  protected:
  explicit GetRestDelegateAmountAck(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:GetRestDelegateAmountAck)
 private:
  class _Internal;
...
// string version = 1;
inline void GetDelegateListReq::clear_version() {
  _impl_.version_.ClearToEmpty();
}
inline const std::string& GetDelegateListReq::version() const {
  // @@protoc_insertion_point(field_get:GetDelegateListReq.version)
  return _internal_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetDelegateListReq::set_version(ArgT0&& arg0, ArgT... args) {
 
 _impl_.version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetDelegateListReq.version)
}
inline std::string* GetDelegateListReq::mutable_version() {
  std::string* _s = _internal_mutable_version();
  // @@protoc_insertion_point(field_mutable:GetDelegateListReq.version)
  return _s;
}
inline const std::string& GetDelegateListReq::_internal_version() const {
  return _impl_.version_.Get();
}
inline void GetDelegateListReq::_internal_set_version(const std::string& value) {
  
  _impl_.version_.Set(value, GetArenaForAllocation());
}
inline std::string* GetDelegateListReq::_internal_mutable_version() {
  
  return _impl_.version_.Mutable(GetArenaForAllocation());
}
inline std::string* GetDelegateListReq::release_version() {
  // @@protoc_insertion_point(field_release:GetDelegateListReq.version)
  return _impl_.version_.Release();
}
inline void GetDelegateListReq::set_allocated_version(std::string* version) {
  if (version != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetDelegateListReq.version)
}

// string addr = 2;
inline void GetDelegateListReq::clear_addr() {
  _impl_.addr_.ClearToEmpty();
}
inline const std::string& GetDelegateListReq::addr() const {
  // @@protoc_insertion_point(field_get:GetDelegateListReq.addr)
  return _internal_addr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetDelegateListReq::set_addr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetDelegateListReq.addr)
}
inline std::string* GetDelegateListReq::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:GetDelegateListReq.addr)
  return _s;
}
inline const std::string& GetDelegateListReq::_internal_addr() const {
  return _impl_.addr_.Get();
}
inline void GetDelegateListReq::_internal_set_addr(const std::string& value) {
  
  _impl_.addr_.Set(value, GetArenaForAllocation());
}
inline std::string* GetDelegateListReq::_internal_mutable_addr() {
  
  return _impl_.addr_.Mutable(GetArenaForAllocation());
}
inline std::string* GetDelegateListReq::release_addr() {
  // @@protoc_insertion_point(field_release:GetDelegateListReq.addr)
  return _impl_.addr_.Release();
}
inline void GetDelegateListReq::set_allocated_addr(std::string* addr) {
  if (addr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetDelegateListReq.addr)
}
...
// string blockhash = 1;
inline void DelegateItem::clear_blockhash() {
  _impl_.blockhash_.ClearToEmpty();
}
inline const std::string& DelegateItem::blockhash() const {
  // @@protoc_insertion_point(field_get:DelegateItem.blockhash)
  return _internal_blockhash();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DelegateItem::set_blockhash(ArgT0&& arg0, ArgT... args) {
 
 _impl_.blockhash_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:DelegateItem.blockhash)
}
inline std::string* DelegateItem::mutable_blockhash() {
  std::string* _s = _internal_mutable_blockhash();
  // @@protoc_insertion_point(field_mutable:DelegateItem.blockhash)
  return _s;
}
inline const std::string& DelegateItem::_internal_blockhash() const {
  return _impl_.blockhash_.Get();
}
inline void DelegateItem::_internal_set_blockhash(const std::string& value) {
  
  _impl_.blockhash_.Set(value, GetArenaForAllocation());
}
inline std::string* DelegateItem::_internal_mutable_blockhash() {
  
  return _impl_.blockhash_.Mutable(GetArenaForAllocation());
}
inline std::string* DelegateItem::release_blockhash() {
  // @@protoc_insertion_point(field_release:DelegateItem.blockhash)
  return _impl_.blockhash_.Release();
}
inline void DelegateItem::set_allocated_blockhash(std::string* blockhash) {
  if (blockhash != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:DelegateItem.blockhash)
}

// uint32 blockheight = 2;
inline void DelegateItem::clear_blockheight() {
  _impl_.blockheight_ = 0u;
}
inline uint32_t DelegateItem::_internal_blockheight() const {
  return _impl_.blockheight_;
}
inline uint32_t DelegateItem::blockheight() const {
  // @@protoc_insertion_point(field_get:DelegateItem.blockheight)
  return _internal_blockheight();
}
inline void DelegateItem::_internal_set_blockheight(uint32_t value) {
  
  _impl_.blockheight_ = value;
}
inline void DelegateItem::set_blockheight(uint32_t value) {
  _internal_set_blockheight(value);
  // @@protoc_insertion_point(field_set:DelegateItem.blockheight)
}

// string utxo = 3;
inline void DelegateItem::clear_utxo() {
  _impl_.utxo_.ClearToEmpty();
}
inline const std::string& DelegateItem::utxo() const {
  // @@protoc_insertion_point(field_get:DelegateItem.utxo)
  return _internal_utxo();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DelegateItem::set_utxo(ArgT0&& arg0, ArgT... args) {
 
 _impl_.utxo_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:DelegateItem.utxo)
}
inline std::string* DelegateItem::mutable_utxo() {
  std::string* _s = _internal_mutable_utxo();
  // @@protoc_insertion_point(field_mutable:DelegateItem.utxo)
  return _s;
}
inline const std::string& DelegateItem::_internal_utxo() const {
  return _impl_.utxo_.Get();
}
inline void DelegateItem::_internal_set_utxo(const std::string& value) {
  
  _impl_.utxo_.Set(value, GetArenaForAllocation());
}
inline std::string* DelegateItem::_internal_mutable_utxo() {
  
  return _impl_.utxo_.Mutable(GetArenaForAllocation());
}
inline std::string* DelegateItem::release_utxo() {
  // @@protoc_insertion_point(field_release:DelegateItem.utxo)
  return _impl_.utxo_.Release();
}
inline void DelegateItem::set_allocated_utxo(std::string* utxo) {
  if (utxo != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:DelegateItem.utxo)
}

// uint64 amount = 4;
inline void DelegateItem::clear_amount() {
  _impl_.amount_ = uint64_t{0u};
}
inline uint64_t DelegateItem::_internal_amount() const {
  return _impl_.amount_;
}
inline uint64_t DelegateItem::amount() const {
  // @@protoc_insertion_point(field_get:DelegateItem.amount)
  return _internal_amount();
}
inline void DelegateItem::_internal_set_amount(uint64_t value) {
  
  _impl_.amount_ = value;
}
inline void DelegateItem::set_amount(uint64_t value) {
  _internal_set_amount(value);
  // @@protoc_insertion_point(field_set:DelegateItem.amount)
}

// uint64 time = 5;
inline void DelegateItem::clear_time() {
  _impl_.time_ = uint64_t{0u};
}
inline uint64_t DelegateItem::_internal_time() const {
  return _impl_.time_;
}
inline uint64_t DelegateItem::time() const {
  // @@protoc_insertion_point(field_get:DelegateItem.time)
  return _internal_time();
}
inline void DelegateItem::_internal_set_time(uint64_t value) {
  
  _impl_.time_ = value;
}
inline void DelegateItem::set_time(uint64_t value) {
  _internal_set_time(value);
  // @@protoc_insertion_point(field_set:DelegateItem.time)
}

// string fromaddr = 6;
inline void DelegateItem::clear_fromaddr() {
  _impl_.fromaddr_.ClearToEmpty();
}
inline const std::string& DelegateItem::fromaddr() const {
  // @@protoc_insertion_point(field_get:DelegateItem.fromaddr)
  return _internal_fromaddr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DelegateItem::set_fromaddr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.fromaddr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:DelegateItem.fromaddr)
}
inline std::string* DelegateItem::mutable_fromaddr() {
  std::string* _s = _internal_mutable_fromaddr();
  // @@protoc_insertion_point(field_mutable:DelegateItem.fromaddr)
  return _s;
}
inline const std::string& DelegateItem::_internal_fromaddr() const {
  return _impl_.fromaddr_.Get();
}
inline void DelegateItem::_internal_set_fromaddr(const std::string& value) {
  
  _impl_.fromaddr_.Set(value, GetArenaForAllocation());
}
inline std::string* DelegateItem::_internal_mutable_fromaddr() {
  
  return _impl_.fromaddr_.Mutable(GetArenaForAllocation());
}
inline std::string* DelegateItem::release_fromaddr() {
  // @@protoc_insertion_point(field_release:DelegateItem.fromaddr)
  return _impl_.fromaddr_.Release();
}
inline void DelegateItem::set_allocated_fromaddr(std::string* fromaddr) {
  if (fromaddr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:DelegateItem.fromaddr)
}

// string toaddr = 7;
inline void DelegateItem::clear_toaddr() {
  _impl_.toaddr_.ClearToEmpty();
}
inline const std::string& DelegateItem::toaddr() const {
  // @@protoc_insertion_point(field_get:DelegateItem.toaddr)
  return _internal_toaddr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DelegateItem::set_toaddr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.toaddr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:DelegateItem.toaddr)
}
inline std::string* DelegateItem::mutable_toaddr() {
  std::string* _s = _internal_mutable_toaddr();
  // @@protoc_insertion_point(field_mutable:DelegateItem.toaddr)
  return _s;
}
inline const std::string& DelegateItem::_internal_toaddr() const {
  return _impl_.toaddr_.Get();
}
inline void DelegateItem::_internal_set_toaddr(const std::string& value) {
  
  _impl_.toaddr_.Set(value, GetArenaForAllocation());
}
inline std::string* DelegateItem::_internal_mutable_toaddr() {
  
  return _impl_.toaddr_.Mutable(GetArenaForAllocation());
}
inline std::string* DelegateItem::release_toaddr() {
  // @@protoc_insertion_point(field_release:DelegateItem.toaddr)
  return _impl_.toaddr_.Release();
}
inline void DelegateItem::set_allocated_toaddr(std::string* toaddr) {
  if (toaddr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:DelegateItem.toaddr)
}

// string detail = 8;
inline void DelegateItem::clear_detail() {
  _impl_.detail_.ClearToEmpty();
}
inline const std::string& DelegateItem::detail() const {
  // @@protoc_insertion_point(field_get:DelegateItem.detail)
  return _internal_detail();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DelegateItem::set_detail(ArgT0&& arg0, ArgT... args) {
 
 _impl_.detail_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:DelegateItem.detail)
}
inline std::string* DelegateItem::mutable_detail() {
  std::string* _s = _internal_mutable_detail();
  // @@protoc_insertion_point(field_mutable:DelegateItem.detail)
  return _s;
}
inline const std::string& DelegateItem::_internal_detail() const {
  return _impl_.detail_.Get();
}
inline void DelegateItem::_internal_set_detail(const std::string& value) {
  
  _impl_.detail_.Set(value, GetArenaForAllocation());
}
inline std::string* DelegateItem::_internal_mutable_detail() {
  
  return _impl_.detail_.Mutable(GetArenaForAllocation());
}
inline std::string* DelegateItem::release_detail() {
  // @@protoc_insertion_point(field_release:DelegateItem.detail)
  return _impl_.detail_.Release();
}
inline void DelegateItem::set_allocated_detail(std::string* detail) {
  if (detail != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:DelegateItem.detail)
}
...
// string version = 1;
inline void GetDelegateListAck::clear_version() {
  _impl_.version_.ClearToEmpty();
}
inline const std::string& GetDelegateListAck::version() const {
  // @@protoc_insertion_point(field_get:GetDelegateListAck.version)
  return _internal_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetDelegateListAck::set_version(ArgT0&& arg0, ArgT... args) {
 
 _impl_.version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetDelegateListAck.version)
}
inline std::string* GetDelegateListAck::mutable_version() {
  std::string* _s = _internal_mutable_version();
  // @@protoc_insertion_point(field_mutable:GetDelegateListAck.version)
  return _s;
}
inline const std::string& GetDelegateListAck::_internal_version() const {
  return _impl_.version_.Get();
}
inline void GetDelegateListAck::_internal_set_version(const std::string& value) {
  
  _impl_.version_.Set(value, GetArenaForAllocation());
}
inline std::string* GetDelegateListAck::_internal_mutable_version() {
  
  return _impl_.version_.Mutable(GetArenaForAllocation());
}
inline std::string* GetDelegateListAck::release_version() {
  // @@protoc_insertion_point(field_release:GetDelegateListAck.version)
  return _impl_.version_.Release();
}
inline void GetDelegateListAck::set_allocated_version(std::string* version) {
  if (version != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetDelegateListAck.version)
}

// int32 code = 2;
inline void GetDelegateListAck::clear_code() {
  _impl_.code_ = 0;
}
inline int32_t GetDelegateListAck::_internal_code() const {
  return _impl_.code_;
}
inline int32_t GetDelegateListAck::code() const {
  // @@protoc_insertion_point(field_get:GetDelegateListAck.code)
  return _internal_code();
}
inline void GetDelegateListAck::_internal_set_code(int32_t value) {
  
  _impl_.code_ = value;
}
inline void GetDelegateListAck::set_code(int32_t value) {
  _internal_set_code(value);
  // @@protoc_insertion_point(field_set:GetDelegateListAck.code)
}

// string message = 3;
inline void GetDelegateListAck::clear_message() {
  _impl_.message_.ClearToEmpty();
}
inline const std::string& GetDelegateListAck::message() const {
  // @@protoc_insertion_point(field_get:GetDelegateListAck.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetDelegateListAck::set_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetDelegateListAck.message)
}
inline std::string* GetDelegateListAck::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:GetDelegateListAck.message)
  return _s;
}
inline const std::string& GetDelegateListAck::_internal_message() const {
  return _impl_.message_.Get();
}
inline void GetDelegateListAck::_internal_set_message(const std::string& value) {
  
  _impl_.message_.Set(value, GetArenaForAllocation());
}
inline std::string* GetDelegateListAck::_internal_mutable_message() {
  
  return _impl_.message_.Mutable(GetArenaForAllocation());
}
inline std::string* GetDelegateListAck::release_message() {
  // @@protoc_insertion_point(field_release:GetDelegateListAck.message)
  return _impl_.message_.Release();
}
inline void GetDelegateListAck::set_allocated_message(std::string* message) {
  if (message != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetDelegateListAck.message)
}

// repeated .DelegateItem list = 4;
inline int GetDelegateListAck::_internal_list_size() const {
  return _impl_.list_.size();
}
inline int GetDelegateListAck::list_size() const {
  return _internal_list_size();
}
inline void GetDelegateListAck::clear_list() {
  _impl_.list_.Clear();
}
inline ::DelegateItem* GetDelegateListAck::mutable_list(int index) {
  // @@protoc_insertion_point(field_mutable:GetDelegateListAck.list)
  return _impl_.list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateItem >*
GetDelegateListAck::mutable_list() {
  // @@protoc_insertion_point(field_mutable_list:GetDelegateListAck.list)
  return &_impl_.list_;
}
inline const ::DelegateItem& GetDelegateListAck::_internal_list(int index) const {
  return _impl_.list_.Get(index);
}
inline const ::DelegateItem& GetDelegateListAck::list(int index) const {
  // @@protoc_insertion_point(field_get:GetDelegateListAck.list)
  return _internal_list(index);
}
inline ::DelegateItem* GetDelegateListAck::_internal_add_list() {
  return _impl_.list_.Add();
}
inline ::DelegateItem* GetDelegateListAck::add_list() {
  ::DelegateItem* _add = _internal_add_list();
  // @@protoc_insertion_point(field_add:GetDelegateListAck.list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateItem >&
GetDelegateListAck::list() const {
  // @@protoc_insertion_point(field_list:GetDelegateListAck.list)
  return _impl_.list_;
}
...
// string version = 1;
inline void GetAllDelegateAddressReq::clear_version() {
  _impl_.version_.ClearToEmpty();
}
inline const std::string& GetAllDelegateAddressReq::version() const {
  // @@protoc_insertion_point(field_get:GetAllDelegateAddressReq.version)
  return _internal_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetAllDelegateAddressReq::set_version(ArgT0&& arg0, ArgT... args) {
 
 _impl_.version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetAllDelegateAddressReq.version)
}
inline std::string* GetAllDelegateAddressReq::mutable_version() {
  std::string* _s = _internal_mutable_version();
  // @@protoc_insertion_point(field_mutable:GetAllDelegateAddressReq.version)
  return _s;
}
inline const std::string& GetAllDelegateAddressReq::_internal_version() const {
  return _impl_.version_.Get();
}
inline void GetAllDelegateAddressReq::_internal_set_version(const std::string& value) {
  
  _impl_.version_.Set(value, GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressReq::_internal_mutable_version() {
  
  return _impl_.version_.Mutable(GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressReq::release_version() {
  // @@protoc_insertion_point(field_release:GetAllDelegateAddressReq.version)
  return _impl_.version_.Release();
}
inline void GetAllDelegateAddressReq::set_allocated_version(std::string* version) {
  if (version != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetAllDelegateAddressReq.version)
}

// string addr = 2;
inline void GetAllDelegateAddressReq::clear_addr() {
  _impl_.addr_.ClearToEmpty();
}
inline const std::string& GetAllDelegateAddressReq::addr() const {
  // @@protoc_insertion_point(field_get:GetAllDelegateAddressReq.addr)
  return _internal_addr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetAllDelegateAddressReq::set_addr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetAllDelegateAddressReq.addr)
}
inline std::string* GetAllDelegateAddressReq::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:GetAllDelegateAddressReq.addr)
  return _s;
}
inline const std::string& GetAllDelegateAddressReq::_internal_addr() const {
  return _impl_.addr_.Get();
}
inline void GetAllDelegateAddressReq::_internal_set_addr(const std::string& value) {
  
  _impl_.addr_.Set(value, GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressReq::_internal_mutable_addr() {
  
  return _impl_.addr_.Mutable(GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressReq::release_addr() {
  // @@protoc_insertion_point(field_release:GetAllDelegateAddressReq.addr)
  return _impl_.addr_.Release();
}
inline void GetAllDelegateAddressReq::set_allocated_addr(std::string* addr) {
  if (addr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetAllDelegateAddressReq.addr)
}
...
// string addr = 1;
inline void DelegateAddressItem::clear_addr() {
  _impl_.addr_.ClearToEmpty();
}
inline const std::string& DelegateAddressItem::addr() const {
  // @@protoc_insertion_point(field_get:DelegateAddressItem.addr)
  return _internal_addr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DelegateAddressItem::set_addr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:DelegateAddressItem.addr)
}
inline std::string* DelegateAddressItem::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:DelegateAddressItem.addr)
  return _s;
}
inline const std::string& DelegateAddressItem::_internal_addr() const {
  return _impl_.addr_.Get();
}
inline void DelegateAddressItem::_internal_set_addr(const std::string& value) {
  
  _impl_.addr_.Set(value, GetArenaForAllocation());
}
inline std::string* DelegateAddressItem::_internal_mutable_addr() {
  
  return _impl_.addr_.Mutable(GetArenaForAllocation());
}
inline std::string* DelegateAddressItem::release_addr() {
  // @@protoc_insertion_point(field_release:DelegateAddressItem.addr)
  return _impl_.addr_.Release();
}
inline void DelegateAddressItem::set_allocated_addr(std::string* addr) {
  if (addr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:DelegateAddressItem.addr)
}

// uint64 value = 2;
inline void DelegateAddressItem::clear_value() {
  _impl_.value_ = uint64_t{0u};
}
inline uint64_t DelegateAddressItem::_internal_value() const {
  return _impl_.value_;
}
inline uint64_t DelegateAddressItem::value() const {
  // @@protoc_insertion_point(field_get:DelegateAddressItem.value)
  return _internal_value();
}
inline void DelegateAddressItem::_internal_set_value(uint64_t value) {
  
  _impl_.value_ = value;
}
inline void DelegateAddressItem::set_value(uint64_t value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:DelegateAddressItem.value)
}
...
// string version = 1;
inline void GetAllDelegateAddressAck::clear_version() {
  _impl_.version_.ClearToEmpty();
}
inline const std::string& GetAllDelegateAddressAck::version() const {
  // @@protoc_insertion_point(field_get:GetAllDelegateAddressAck.version)
  return _internal_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetAllDelegateAddressAck::set_version(ArgT0&& arg0, ArgT... args) {
 
 _impl_.version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetAllDelegateAddressAck.version)
}
inline std::string* GetAllDelegateAddressAck::mutable_version() {
  std::string* _s = _internal_mutable_version();
  // @@protoc_insertion_point(field_mutable:GetAllDelegateAddressAck.version)
  return _s;
}
inline const std::string& GetAllDelegateAddressAck::_internal_version() const {
  return _impl_.version_.Get();
}
inline void GetAllDelegateAddressAck::_internal_set_version(const std::string& value) {
  
  _impl_.version_.Set(value, GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressAck::_internal_mutable_version() {
  
  return _impl_.version_.Mutable(GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressAck::release_version() {
  // @@protoc_insertion_point(field_release:GetAllDelegateAddressAck.version)
  return _impl_.version_.Release();
}
inline void GetAllDelegateAddressAck::set_allocated_version(std::string* version) {
  if (version != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetAllDelegateAddressAck.version)
}

// sint32 code = 2;
inline void GetAllDelegateAddressAck::clear_code() {
  _impl_.code_ = 0;
}
inline int32_t GetAllDelegateAddressAck::_internal_code() const {
  return _impl_.code_;
}
inline int32_t GetAllDelegateAddressAck::code() const {
  // @@protoc_insertion_point(field_get:GetAllDelegateAddressAck.code)
  return _internal_code();
}
inline void GetAllDelegateAddressAck::_internal_set_code(int32_t value) {
  
  _impl_.code_ = value;
}
inline void GetAllDelegateAddressAck::set_code(int32_t value) {
  _internal_set_code(value);
  // @@protoc_insertion_point(field_set:GetAllDelegateAddressAck.code)
}

// string message = 3;
inline void GetAllDelegateAddressAck::clear_message() {
  _impl_.message_.ClearToEmpty();
}
inline const std::string& GetAllDelegateAddressAck::message() const {
  // @@protoc_insertion_point(field_get:GetAllDelegateAddressAck.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetAllDelegateAddressAck::set_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetAllDelegateAddressAck.message)
}
inline std::string* GetAllDelegateAddressAck::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:GetAllDelegateAddressAck.message)
  return _s;
}
inline const std::string& GetAllDelegateAddressAck::_internal_message() const {
  return _impl_.message_.Get();
}
inline void GetAllDelegateAddressAck::_internal_set_message(const std::string& value) {
  
  _impl_.message_.Set(value, GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressAck::_internal_mutable_message() {
  
  return _impl_.message_.Mutable(GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressAck::release_message() {
  // @@protoc_insertion_point(field_release:GetAllDelegateAddressAck.message)
  return _impl_.message_.Release();
}
inline void GetAllDelegateAddressAck::set_allocated_message(std::string* message) {
  if (message != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetAllDelegateAddressAck.message)
}

// string addr = 4;
inline void GetAllDelegateAddressAck::clear_addr() {
  _impl_.addr_.ClearToEmpty();
}
inline const std::string& GetAllDelegateAddressAck::addr() const {
  // @@protoc_insertion_point(field_get:GetAllDelegateAddressAck.addr)
  return _internal_addr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetAllDelegateAddressAck::set_addr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetAllDelegateAddressAck.addr)
}
inline std::string* GetAllDelegateAddressAck::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:GetAllDelegateAddressAck.addr)
  return _s;
}
inline const std::string& GetAllDelegateAddressAck::_internal_addr() const {
  return _impl_.addr_.Get();
}
inline void GetAllDelegateAddressAck::_internal_set_addr(const std::string& value) {
  
  _impl_.addr_.Set(value, GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressAck::_internal_mutable_addr() {
  
  return _impl_.addr_.Mutable(GetArenaForAllocation());
}
inline std::string* GetAllDelegateAddressAck::release_addr() {
  // @@protoc_insertion_point(field_release:GetAllDelegateAddressAck.addr)
  return _impl_.addr_.Release();
}
inline void GetAllDelegateAddressAck::set_allocated_addr(std::string* addr) {
  if (addr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetAllDelegateAddressAck.addr)
}

// repeated .DelegateAddressItem list = 5;
inline int GetAllDelegateAddressAck::_internal_list_size() const {
  return _impl_.list_.size();
}
inline int GetAllDelegateAddressAck::list_size() const {
  return _internal_list_size();
}
inline void GetAllDelegateAddressAck::clear_list() {
  _impl_.list_.Clear();
}
inline ::DelegateAddressItem* GetAllDelegateAddressAck::mutable_list(int index) {
  // @@protoc_insertion_point(field_mutable:GetAllDelegateAddressAck.list)
  return _impl_.list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateAddressItem >*
GetAllDelegateAddressAck::mutable_list() {
  // @@protoc_insertion_point(field_mutable_list:GetAllDelegateAddressAck.list)
  return &_impl_.list_;
}
inline const ::DelegateAddressItem& GetAllDelegateAddressAck::_internal_list(int index) const {
  return _impl_.list_.Get(index);
}
inline const ::DelegateAddressItem& GetAllDelegateAddressAck::list(int index) const {
  // @@protoc_insertion_point(field_get:GetAllDelegateAddressAck.list)
  return _internal_list(index);
}
inline ::DelegateAddressItem* GetAllDelegateAddressAck::_internal_add_list() {
  return _impl_.list_.Add();
}
inline ::DelegateAddressItem* GetAllDelegateAddressAck::add_list() {
  ::DelegateAddressItem* _add = _internal_add_list();
  // @@protoc_insertion_point(field_add:GetAllDelegateAddressAck.list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::DelegateAddressItem >&
GetAllDelegateAddressAck::list() const {
  // @@protoc_insertion_point(field_list:GetAllDelegateAddressAck.list)
  return _impl_.list_;
}
...
// string version = 1;
inline void GetRestDelegateAmountReq::clear_version() {
  _impl_.version_.ClearToEmpty();
}
inline const std::string& GetRestDelegateAmountReq::version() const {
  // @@protoc_insertion_point(field_get:GetRestDelegateAmountReq.version)
  return _internal_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetRestDelegateAmountReq::set_version(ArgT0&& arg0, ArgT... args) {
 
 _impl_.version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetRestDelegateAmountReq.version)
}
inline std::string* GetRestDelegateAmountReq::mutable_version() {
  std::string* _s = _internal_mutable_version();
  // @@protoc_insertion_point(field_mutable:GetRestDelegateAmountReq.version)
  return _s;
}
inline const std::string& GetRestDelegateAmountReq::_internal_version() const {
  return _impl_.version_.Get();
}
inline void GetRestDelegateAmountReq::_internal_set_version(const std::string& value) {
  
  _impl_.version_.Set(value, GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountReq::_internal_mutable_version() {
  
  return _impl_.version_.Mutable(GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountReq::release_version() {
  // @@protoc_insertion_point(field_release:GetRestDelegateAmountReq.version)
  return _impl_.version_.Release();
}
inline void GetRestDelegateAmountReq::set_allocated_version(std::string* version) {
  if (version != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetRestDelegateAmountReq.version)
}

// string addr = 2;
inline void GetRestDelegateAmountReq::clear_addr() {
  _impl_.addr_.ClearToEmpty();
}
inline const std::string& GetRestDelegateAmountReq::addr() const {
  // @@protoc_insertion_point(field_get:GetRestDelegateAmountReq.addr)
  return _internal_addr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetRestDelegateAmountReq::set_addr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetRestDelegateAmountReq.addr)
}
inline std::string* GetRestDelegateAmountReq::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:GetRestDelegateAmountReq.addr)
  return _s;
}
inline const std::string& GetRestDelegateAmountReq::_internal_addr() const {
  return _impl_.addr_.Get();
}
inline void GetRestDelegateAmountReq::_internal_set_addr(const std::string& value) {
  
  _impl_.addr_.Set(value, GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountReq::_internal_mutable_addr() {
  
  return _impl_.addr_.Mutable(GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountReq::release_addr() {
  // @@protoc_insertion_point(field_release:GetRestDelegateAmountReq.addr)
  return _impl_.addr_.Release();
}
inline void GetRestDelegateAmountReq::set_allocated_addr(std::string* addr) {
  if (addr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetRestDelegateAmountReq.addr)
}
...
// string version = 1;
inline void GetRestDelegateAmountAck::clear_version() {
  _impl_.version_.ClearToEmpty();
}
inline const std::string& GetRestDelegateAmountAck::version() const {
  // @@protoc_insertion_point(field_get:GetRestDelegateAmountAck.version)
  return _internal_version();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetRestDelegateAmountAck::set_version(ArgT0&& arg0, ArgT... args) {
 
 _impl_.version_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetRestDelegateAmountAck.version)
}
inline std::string* GetRestDelegateAmountAck::mutable_version() {
  std::string* _s = _internal_mutable_version();
  // @@protoc_insertion_point(field_mutable:GetRestDelegateAmountAck.version)
  return _s;
}
inline const std::string& GetRestDelegateAmountAck::_internal_version() const {
  return _impl_.version_.Get();
}
inline void GetRestDelegateAmountAck::_internal_set_version(const std::string& value) {
  
  _impl_.version_.Set(value, GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountAck::_internal_mutable_version() {
  
  return _impl_.version_.Mutable(GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountAck::release_version() {
  // @@protoc_insertion_point(field_release:GetRestDelegateAmountAck.version)
  return _impl_.version_.Release();
}
inline void GetRestDelegateAmountAck::set_allocated_version(std::string* version) {
  if (version != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetRestDelegateAmountAck.version)
}

// int32 code = 2;
inline void GetRestDelegateAmountAck::clear_code() {
  _impl_.code_ = 0;
}
inline int32_t GetRestDelegateAmountAck::_internal_code() const {
  return _impl_.code_;
}
inline int32_t GetRestDelegateAmountAck::code() const {
  // @@protoc_insertion_point(field_get:GetRestDelegateAmountAck.code)
  return _internal_code();
}
inline void GetRestDelegateAmountAck::_internal_set_code(int32_t value) {
  
  _impl_.code_ = value;
}
inline void GetRestDelegateAmountAck::set_code(int32_t value) {
  _internal_set_code(value);
  // @@protoc_insertion_point(field_set:GetRestDelegateAmountAck.code)
}

// string message = 3;
inline void GetRestDelegateAmountAck::clear_message() {
  _impl_.message_.ClearToEmpty();
}
inline const std::string& GetRestDelegateAmountAck::message() const {
  // @@protoc_insertion_point(field_get:GetRestDelegateAmountAck.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetRestDelegateAmountAck::set_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetRestDelegateAmountAck.message)
}
inline std::string* GetRestDelegateAmountAck::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:GetRestDelegateAmountAck.message)
  return _s;
}
inline const std::string& GetRestDelegateAmountAck::_internal_message() const {
  return _impl_.message_.Get();
}
inline void GetRestDelegateAmountAck::_internal_set_message(const std::string& value) {
  
  _impl_.message_.Set(value, GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountAck::_internal_mutable_message() {
  
  return _impl_.message_.Mutable(GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountAck::release_message() {
  // @@protoc_insertion_point(field_release:GetRestDelegateAmountAck.message)
  return _impl_.message_.Release();
}
inline void GetRestDelegateAmountAck::set_allocated_message(std::string* message) {
  if (message != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetRestDelegateAmountAck.message)
}

// uint64 amount = 4;
inline void GetRestDelegateAmountAck::clear_amount() {
  _impl_.amount_ = uint64_t{0u};
}
inline uint64_t GetRestDelegateAmountAck::_internal_amount() const {
  return _impl_.amount_;
}
inline uint64_t GetRestDelegateAmountAck::amount() const {
  // @@protoc_insertion_point(field_get:GetRestDelegateAmountAck.amount)
  return _internal_amount();
}
inline void GetRestDelegateAmountAck::_internal_set_amount(uint64_t value) {
  
  _impl_.amount_ = value;
}
inline void GetRestDelegateAmountAck::set_amount(uint64_t value) {
  _internal_set_amount(value);
  // @@protoc_insertion_point(field_set:GetRestDelegateAmountAck.amount)
}

// string addr = 5;
inline void GetRestDelegateAmountAck::clear_addr() {
  _impl_.addr_.ClearToEmpty();
}
inline const std::string& GetRestDelegateAmountAck::addr() const {
  // @@protoc_insertion_point(field_get:GetRestDelegateAmountAck.addr)
  return _internal_addr();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetRestDelegateAmountAck::set_addr(ArgT0&& arg0, ArgT... args) {
 
 _impl_.addr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:GetRestDelegateAmountAck.addr)
}
inline std::string* GetRestDelegateAmountAck::mutable_addr() {
  std::string* _s = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:GetRestDelegateAmountAck.addr)
  return _s;
}
inline const std::string& GetRestDelegateAmountAck::_internal_addr() const {
  return _impl_.addr_.Get();
}
inline void GetRestDelegateAmountAck::_internal_set_addr(const std::string& value) {
  
  _impl_.addr_.Set(value, GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountAck::_internal_mutable_addr() {
  
  return _impl_.addr_.Mutable(GetArenaForAllocation());
}
inline std::string* GetRestDelegateAmountAck::release_addr() {
  // @@protoc_insertion_point(field_release:GetRestDelegateAmountAck.addr)
  return _impl_.addr_.Release();
}
inline void GetRestDelegateAmountAck::set_allocated_addr(std::string* addr) {
  if (addr != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:GetRestDelegateAmountAck.addr)
}
